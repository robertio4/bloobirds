...
const createAlignPlugin = plateCore.createPluginFactory({
  ...
  then: editor => ({
    ...
    then: (_, plugin) => plateCore.mapInjectPropsToPlugin(editor, plugin, {
      deserializeHtml: {
        getNode: (el, node) => {
