...
const getEmojiOnInsert = ({
  ...
  plateCore.withoutNormalizing(editor, () => {
    ...
    plateCore.insertText(editor, value);
  });
};
...
const getEmojiOnSelectItem = ({
  ...
  plateCore.withoutNormalizing(editor, () => {
    plateCore.withoutMergingHistory(editor, () => plateCore.deleteText(editor, {
...
const getNextPoint = (editor, endPoint) => plateCore.getPointBefore(editor, endPoint, {
  unit: 'character',
  distance: 1
});

const getFoundText = (editor, start, end) => plateCore.getEditorString(editor, plateCore.getRange(editor, start, end));
...
const withEmoji = (editor, {
  ...
  editor.insertText = text => {
    ...
    if (!selection || !plateCore.isCollapsed(selection)) return insertText(text);
...
const createEmojiPlugin = plateCore.createPluginFactory({
  key: KEY_EMOJI,
  // handlers: {
...
exports.EMOJI_TRIGGERING_CONTROLLER_OPTIONS = EMOJI_TRIGGERING_CONTROLLER_OPTIONS;
...
exports.getOnKeyDownEmoji = getOnKeyDownEmoji;
exports.i18n = i18n;
