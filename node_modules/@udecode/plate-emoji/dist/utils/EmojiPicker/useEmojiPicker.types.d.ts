...
import { EmojiCategoryList, EmojiIconList, EmojiSettingsType, i18nProps } from '../../types';
...
export declare type MutableRefs = MutableRefObject<{
    contentRoot: RefObject<HTMLDivElement> | undefined;
    content: RefObject<HTMLDivElement> | undefined;
}>;
export declare type UseEmojiPickerProps = {
    closeOnSelect: boolean;
    editor: PlateEditor;
    emojiLibrary: IEmojiFloatingLibrary;
    indexSearch: AIndexSearch<Emoji>;
};
export declare type UseEmojiPickerType<T extends JSX.Element = JSX.Element> = {
    isOpen: boolean;
    onToggle: () => void;
    i18n: i18nProps;
    searchValue: string;
...
//# sourceMappingURL=useEmojiPicker.types.d.ts.map