...
export declare type TabDestinationPath = {
    type: 'path';
    path: TPath;
};
export declare type TabDestinationDOMNode = {
    type: 'dom-node';
    domNode: HTMLElement;
};
export declare type TabDestination = TabDestinationPath | TabDestinationDOMNode;
export declare type TabbableEntry = {
    domNode: HTMLElement;
    slateNode: TNode;
    path: TPath;
};
