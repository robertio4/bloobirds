 ...
 */
export declare const unhangRange: <V extends Value>(editor: TEditor<V>, range?: import("slate").BaseRange | Path | import("slate").BasePoint | Span | null | undefined, options?: UnhangRangeOptions) => import("slate").BaseRange | undefined;
