...
export declare const withTHistory: <V extends Value = Value, E extends TEditor<V> = TEditor<V>, EE extends E = E & Omit<import("slate").BaseEditor, "children" | "operations" | "marks" | "isInline" | "isVoid" | "markableVoid" | "normalizeNode" | "apply" | "getFragment" | "insertFragment" | "insertNode" | "getDirtyPaths" | "id"> & {
    id: any;
    children: V;
