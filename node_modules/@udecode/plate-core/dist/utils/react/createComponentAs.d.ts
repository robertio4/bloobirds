 ...
 */
export declare const createComponentAs: <O extends AsProps<import("../../types/index").As<any>>>(render: (props: Omit<Props<O>, "asChild">) => ReactElement | Children | null) => Component<O>;
