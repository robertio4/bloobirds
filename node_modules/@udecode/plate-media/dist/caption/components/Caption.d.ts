...
export declare const CaptionRoot: import("@udecode/plate-core").Component<CaptionProps>;
export declare const Caption: {
    Root: import("@udecode/plate-core").Component<CaptionProps>;
    Textarea: import("@udecode/plate-core").Component<import("./CaptionTextarea").CaptionTextareaProps>;
};
