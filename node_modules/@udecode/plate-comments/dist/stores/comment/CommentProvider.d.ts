...
import { Scope, Value } from '@udecode/plate-core';
...
export declare const commentStore: {
    ...
    extend: <ET, EN>(extendedState: ET, options?: Omit<import("@udecode/plate-core").CreateAtomStoreOptions<{}, EN extends string ? EN : "comment">, "initialStore"> | undefined) => import("@udecode/plate-core").AtomStoreApi<CommentStoreState & ET, EN extends string ? EN : "comment">;
}, useCommentStore: (scope?: Scope | undefined) => {
    get: import("@udecode/plate-core").GetRecord<CommentStoreState>;
    set: import("@udecode/plate-core").SetRecord<CommentStoreState>;
    use: import("@udecode/plate-core").UseRecord<CommentStoreState>;
};
export declare const useCommentStates: () => import("@udecode/plate-core").UseRecord<CommentStoreState>;
export declare const useCommentSelectors: () => import("@udecode/plate-core").GetRecord<CommentStoreState>;
export declare const useCommentActions: () => import("@udecode/plate-core").SetRecord<CommentStoreState>;
