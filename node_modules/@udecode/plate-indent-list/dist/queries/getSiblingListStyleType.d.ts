import { EElement, PlateEditor, TElement, TNodeEntry, Value } from '@udecode/plate-core';
...
export declare const getSiblingListStyleType: <V extends Value = Value>(editor: PlateEditor<V>, { entry, indent, ...options }: {
    ...
    indent: number;
} & GetIndentListSiblingsOptions<import("@udecode/plate-core").ElementOf<import("@udecode/plate-core").TEditor<V>>, V>) => ListStyleType;
