...
const PortalBody = ({
  ...
  if (!container) return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, children);
  return /*#__PURE__*/ReactDOM__default["default"].createPortal(children, element || document.body);
};
