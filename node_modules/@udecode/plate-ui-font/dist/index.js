...
const ColorButton = ({
  ...
  const content = /*#__PURE__*/React__default["default"].createElement(_StyledButton, {
  ...
  return name ? /*#__PURE__*/React__default["default"].createElement(Tippy, {
    content: name
  }, content) : content;
};
...
const CustomColors = ({
  ...
  }, /*#__PURE__*/React__default["default"].createElement(_StyledPlateButton$1, null, "CUSTOM")), /*#__PURE__*/React__default["default"].createElement(Colors, {
    color: color,
...
const ColorPicker = /*#__PURE__*/React__default["default"].memo(ColorPickerInternal, (prev, next) => prev.color === next.color && prev.colors === next.colors && prev.customColors === next.customColors && prev.open === next.open);
...
const ColorPickerToolbarDropdown = ({
  ...
  const editorRef = plateCore.usePlateEditorRef(id);
  const [open, setOpen] = React.useState(false);
  const type = plateCore.getPluginType(editorRef, pluginKey);
  const color = editorRef && plateCore.getMark(editorRef, type);
  ...
  const updateColor = React.useCallback(value => {
    if (editorRef && editor && editor.selection) {
      ...
      plateCore.select(editorRef, editor.selection);
      plateCore.focusEditor(editorRef);
      plateCore.setMarks(editor, {
        [type]: value
      });
    }
