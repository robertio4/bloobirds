...
import { useEventPlateId, usePlateEditorState, usePlateEditorRef, getPluginType, getMark, select, focusEditor, setMarks, removeMark, isMarkActive } from '@udecode/plate-core';
import { ToolbarDropdown, ToolbarButton } from '@udecode/plate-ui-toolbar';
...
const ColorButton = ({
  ...
  const content = /*#__PURE__*/React.createElement(_StyledButton, {
  ...
  return name ? /*#__PURE__*/React.createElement(Tippy, {
    content: name
  }, content) : content;
};
...
const CustomColors = ({
  ...
  }, /*#__PURE__*/React.createElement(_StyledPlateButton$1, null, "CUSTOM")), /*#__PURE__*/React.createElement(Colors, {
    color: color,
...
const ColorPicker = /*#__PURE__*/React.memo(ColorPickerInternal, (prev, next) => prev.color === next.color && prev.colors === next.colors && prev.customColors === next.customColors && prev.open === next.open);
