(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./_toSource"], factory);
    }
    ...
    */
    ...
    var dataViewCtorString = _toSource_1.default(DataView), mapCtorString = _toSource_1.default(Map), promiseCtorString = _toSource_1.default(Promise), setCtorString = _toSource_1.default(Set), weakMapCtorString = _toSource_1.default(WeakMap);
    /**
    ...
    if ((DataView && getTag(new DataView(new ArrayBuffer(1))) != enumTags.dataViewTag) ||
        ...
        getTag = function (value) {
            var result = _get_tag(value), Ctor = result == enumTags.objectTag ? value.constructor : undefined, ctorString = Ctor ? _toSource_1.default(Ctor) : undefined;
            if (ctorString) {
                switch (ctorString) {
