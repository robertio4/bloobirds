import { MeasurementUnit, MetricBucketItem } from '@sentry/types';
 ...
 * timestamp: 12345677
 */
export declare function serializeMetricBuckets(metricBucketItems: Array<MetricBucketItem>): string;
