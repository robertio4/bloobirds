import {
  ...
  formatDateAsText,
  getDifferenceInHours, getDifferenceInDays
} from "./dates.utils";
...
describe('getDifferenceInHours', () => {
  // Calculates the difference in hours between two valid dates
  it('should calculate the difference in hours between two valid dates', () => {
    const startDate = new Date('2022-01-01T12:00:00');
    const endDate = new Date('2022-01-01T15:30:00');
    const result = getDifferenceInHours({ startDate, endDate });
    expect(result).toBe(4);
  });

  // Calculates the difference in hours between two dates with the same timestamp
  it('should calculate the difference in hours between two dates with the same timestamp', () => {
    const startDate = new Date('2022-01-01T12:00:00');
    const endDate = new Date('2022-01-01T12:00:00');
    const result = getDifferenceInHours({ startDate, endDate });
    expect(result).toBe(0);
  });

  // Calculates the difference in hours between two dates with a difference of less than an hour
  it('should calculate the difference in hours between two dates with a difference of less than an hour', () => {
    const startDate = new Date('2022-01-01T12:00:00');
  ...
  // Calculates the difference in hours between two dates with a difference of exactly one hour
  it('should calculate the difference in hours between two dates with a difference of exactly one hour', () => {
    const startDate = new Date('2022-01-01T12:00:00');
    const endDate = new Date('2022-01-01T13:00:00');
    const result = getDifferenceInHours({ startDate, endDate });
    expect(result).toBe(1);
  });

  // Calculates the difference in hours between two dates with a difference of exactly 24 hours
  it('should calculate the difference in hours between two dates with a difference of exactly 24 hours', () => {
    const startDate = new Date('2022-01-01T12:00:00');
    const endDate = new Date('2022-01-02T12:00:00');
    const result = getDifferenceInHours({ startDate, endDate });
    expect(result).toBe(24);
  });

  // Calculates the difference in hours between two dates with a difference of exactly 48 hours
  it('should calculate the difference in hours between two dates with a difference of exactly 48 hours', () => {
    const startDate = new Date('2022-01-01T12:00:00');
    const endDate = new Date('2022-01-03T12:00:00');
    const result = getDifferenceInHours({ startDate, endDate });
...
describe('getDifferenceInDays', () => {
  // Calculates difference in days between two valid dates
  it('should calculate difference in days between two valid dates', () => {
    const startDate = new Date('2022-01-01');
    const endDate = new Date('2022-01-10');
    const result = getDifferenceInDays({ startDate, endDate });
    expect(result).toBe(9);
  });

  // Calculates difference in days when start date is equal to end date
  it('should calculate difference in days when start date is equal to end date', () => {
    const startDate = new Date('2022-01-01');
  ...
  // Calculates difference in days when start date is before end date
  it('should calculate difference in days when start date is before end date', () => {
    const startDate = new Date('2022-01-01');
    const endDate = new Date('2022-01-10');
    const result = getDifferenceInDays({ startDate, endDate });
    expect(result).toBe(9);
  ...
  // Calculates difference in days when start date is a string
  it('should calculate difference in days when start date is a string', () => {
  ...
  // Calculates difference in days when end date is a string
  it('should calculate difference in days when end date is a string', () => {
    const startDate = new Date('2022-01-01');
  ...
  // Calculates difference in days when start date and end date are strings
  it('should calculate difference in days when start date and end date are strings', () => {
    const startDate = '2022-01-01';
    const endDate = '2022-01-10';
    const result = getDifferenceInDays({ startDate, endDate });
    expect(result).toBe(9);
