...
var accountSettings$1 = {
	...
	relatedObjects: {
		...
		statusFieldTableHeader: "Status field",
		objectTypeTableHeader: "Reference bobject",
		banner: {
		...
		relationshipsTitlePlaceholder: "Relationships",
		statusFieldTitlePlaceholder: "Status field",
		tooltipAddValues: "Add values to show",
		tooltipEditValues: "Edit values to show",
		tooltipDelete: "Delete related object",
		tooltipRequiredFields: "Choose a field as the title and another as the relationship",
		tooltipDisplayMainObject: "Contact CS if you want to disable this object",
		systemObject: "This is a Bloobirds System Object and cannot be modified",
		confirmCloseModal: {
			title: "Discard Object Value",
		...
		fieldsModal: {
			...
			extraFieldsHelper: "The rest of the values that have been included are not visible in the preview, but will be visible in the object detail.",
			referenceObject: "{{name}} Based",
			referenceObjectTitle: "Select a reference object",
			referenceObjectQuestion: "What’s the type for the reference object?",
			referenceObjectDescription: "Choose the type of object that will serve as a reference when displaying this new main record. Available options will vary depending on your choice.",
			selectReferenceObject: "Select an option to display available values",
			loadingValues: "Loading values from Salesforce. This process may take a few minutes.",
			loadingInfo: "Please don’t close this tab while the process is ongoing.",
			chooseMainObject: "Choose the new main object from Salesforce",
	...
	tabs: {
		...
		salesforceMainObjects: "Main objects",
		salesforceObjects: "Salesforce objects",
...
var accountSettings = {
	...
	relatedObjects: {
		...
		statusFieldTableHeader: "Campo de estado",
		objectTypeTableHeader: "Objecto referencia",
		banner: {
		...
		relationshipsTitlePlaceholder: "Relaciones",
		tooltipAddValues: "Agregar valores para mostrar",
		tooltipEditValues: "Editar valores para mostrar",
		tooltipDelete: "Eliminar objeto relacionado",
		tooltipRequiredFields: "Elige un campo como título y otro como relación",
		tooltipDisplayMainObject: "Póngase en contacto con CS si desea desactivar este objeto",
		systemObject: "Este es un objeto del sistema Bloobirds y no se puede modificar",
		confirmCloseModal: {
		...
		fieldsModal: {
			...
			extraFieldsHelper: "El resto de valores que se han incluido no son visibles en la vista previa, pero sí en el detalle del objeto.",
			referenceObject: "Basado en {{name}}",
			referenceObjectTitle: "Seleccionar un objeto de referencia",
			referenceObjectQuestion: "¿Cuál es el tipo del objeto de referencia?",
			referenceObjectDescription: "Elija el tipo de objeto que servirá como referencia al mostrar este nuevo registro principal. Las opciones disponibles variarán según su elección.",
			selectReferenceObject: "Seleccione una opción para mostrar los valores disponibles",
			loadingValues: "Cargando valores desde Salesforce. Este proceso puede tardar unos minutos.",
			loadingInfo: "Por favor, no cierre esta pestaña mientras el proceso esté en curso.",
			chooseMainObject: "Elija el nuevo objeto principal desde Salesforce",
			selectObject: "Seleccione un objeto...",
			"continue": "Continuar"
		},
		noFieldsAdded: {
	...
	tabs: {
		...
		salesforceMainObjects: "Objectos Principales",
		salesforceObjects: "Objectos de Salesforce",
