...
import { scheduledFieldFilters } from './scheduled.constant';
import {
  useProspectingScheduledQuery,
  useProspectingScheduledSort,
...
export const ScheduledFilters = () => {
  const { setQuery, setSubqueryBobjectType } = useProspectingScheduledQuery();
  const { sort, setSort } = useProspectingScheduledSort();
