...
export const allMyEntitiesLead = [
...
export const SORT_FIELDS = {
  ...
  timeZone: [
    {
      field: LEAD_FIELDS_LOGIC_ROLE.TIME_ZONE,
      direction: 'DESC',
    },
    {
      field: LEAD_FIELDS_LOGIC_ROLE.ASSIGNED_DATE,
  ...
  country: [
    {
      field: LEAD_FIELDS_LOGIC_ROLE.COUNTRY,
      direction: 'ASC',
    },
    {
      field: LEAD_FIELDS_LOGIC_ROLE.ASSIGNED_DATE,
  ...
  name: [
    {
      field: LEAD_FIELDS_LOGIC_ROLE.FULL_NAME,
      direction: 'ASC',
    },
    {
      field: LEAD_FIELDS_LOGIC_ROLE.ASSIGNED_DATE,
  ...
  mrRating: [
    {
      field: LEAD_FIELDS_LOGIC_ROLE.MR_RATING,
      direction: 'ASC',
    },
    {
      field: LEAD_FIELDS_LOGIC_ROLE.ASSIGNED_DATE,
  ...
  cadence: [
    {
      field: LEAD_FIELDS_LOGIC_ROLE.CADENCE,
      direction: 'ASC',
    },
    {
      field: LEAD_FIELDS_LOGIC_ROLE.ASSIGNED_DATE,
