...
import { TASK_ACTION, TASK_FIELDS_LOGIC_ROLE, MainBobjectTypes } from '@bloobirds-it/types';
...
export const nurturingSubQueryTypes: Record<MainBobjectTypes, object> = {
...
export const nurturingCardFieldsArray = [
