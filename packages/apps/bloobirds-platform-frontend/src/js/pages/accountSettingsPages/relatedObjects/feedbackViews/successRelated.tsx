...
const SuccessRelated = ({ onReload }: { onReload: () => void }) => {
  const { t } = useTranslation('translation', {
    keyPrefix: 'accountSettings.relatedObjects.successRelated',
  });

  return (
    <div className={styles.feedbackContainer}>
      <div className={styles.circleBackgroundIcon}>
        <Icon name="checkDouble" size={48} color="bloobirds" />
      </div>
