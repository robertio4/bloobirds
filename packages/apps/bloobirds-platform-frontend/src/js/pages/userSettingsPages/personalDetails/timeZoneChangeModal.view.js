...
import { convertLocationToHourMinutes } from '@bloobirds-it/utils';

const TimeZoneChangeModal = ({ open, close, name, location, save }) => {
  const [disableButton, setDisableButton] = useState(true);

  return (
    <Modal title="Changing your timezone" open={open} onClose={close}>
      <ModalContent>
        <div className={styles._timezone__text}>
        ...
        {name && (
          <div className={styles._timezone__checkbox} align="left">
            <Checkbox
              onClick={checkValue => {
