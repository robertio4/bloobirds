import { createHotContext as __vite__createHotContext } from "/vendor/vite-client.js";import.meta.hot = __vite__createHotContext("/src/content/components/extendedScreen/pages/bobjectDetail/bobjectDetail.tsx.js");import RefreshRuntime from "/vendor/react-refresh.js";
let prevRefreshReg;
let prevRefreshSig;
if (import.meta.hot) {
  ...
  window.$RefreshReg$ = (type, id) => {
    RefreshRuntime.register(type, "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/extendedScreen/pages/bobjectDetail/bobjectDetail.tsx " + id);
  };
  window.$RefreshSig$ = RefreshRuntime.createSignatureFunctionForTransform;
}
var _jsxFileName = "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/extendedScreen/pages/bobjectDetail/bobjectDetail.tsx", _s = $RefreshSig$();
...
import { useBaseSetEmailVariablesValues, useDataModel, useMinimizableModals, useAircallPhoneLinkEnabled } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-src-index.tsx.js";
...
import { api, getSobjectTypeFromId, isEmail, isUrl, isValidPhone, openPhoneOrDialer } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js";
...
import { SectionField } from "/src/content/components/extendedScreen/pages/bobjectDetail/sectionField/sectionField.tsx.js";
import { jsxDEV as _jsxDEV, Fragment as _Fragment } from "/vendor/id-__x00__react-jsx-dev-runtime.js";
export const BobjectDetail = ({
  isB2CAccount = false
}) => {
  _s();
  const {
    ...
    keyPrefix: "extendedScreen.bobjectDetail"
  });
  const {
  ...
  const companyEmailFields = companyFields?.filter((field) => field?.fieldType === "EMAIL");
  const companyPhoneFields = companyFields?.filter((field) => field?.fieldType === "PHONE");
  const leadEmailFields = leadFields?.filter((field) => field?.fieldType === "EMAIL")?.sort((a, b) => a.ordering - b.ordering);
  const leadPhoneFields = leadFields?.filter((field) => field?.fieldType === "PHONE")?.sort((a, b) => a.ordering - b.ordering);
  const mainInfoCompanyFields = companyFields?.filter((field) => ["COMPANY__NAME", "COMPANY__WEBSITE"].includes(field.logicRole))?.sort((a, b) => a.ordering - b.ordering);
  const mainInfoLeadFields = leadFields?.filter((field) => ["LEAD__NAME", "LEAD__SURNAME", "LEAD__LINKEDIN_JOB_TITLE"].includes(field.logicRole));
  const companyLinkedinURLField = companyFields?.filter((field) => field.logicRole === "COMPANY__LINKEDIN_URL");
  const leadLinkedinURLField = leadFields?.filter((field) => field.logicRole === "LEAD__LINKEDIN_URL");
  const sections = [
    {
      title: "",
      ...
      validation: (field) => (value) => {
        if (value) {
          ...
          return field.required ? t("validation.notEmpty") : void 0;
        }
      }
    },
    {
      ...
      validation: (field) => (value) => {
        if (value) {
          return isEmail(value) ? void 0 : t("validation.email");
        } else {
          return field.required ? t("validation.notEmpty") : void 0;
        }
      }
    },
    {
      ...
      validation: (field) => (value) => {
        if (value) {
          return isValidPhone(value) ? void 0 : t("validation.phone");
        } else {
          return field.required ? t("validation.notEmpty") : void 0;
        }
      }
    ...
    !isB2CAccount && {
      ...
      validation: (field) => (value) => {
        if (value) {
          return isUrl(value) ? void 0 : t("validation.url");
        } else {
          return field.required ? t("validation.notEmpty") : void 0;
        }
      }
  ...
  const getContactAction = (type, value) => {
    switch (type) {
      case "EMAIL":
        return /* @__PURE__ */ _jsxDEV(ContactViewAction, {
          color: "tangerine",
          icon: "mail",
          size: "small",
          onClick: () => {
      ...
      case "PHONE":
        return hasAircallPhoneLinkEnabled ? /* @__PURE__ */ _jsxDEV("a", {
          href: `callto:${value}`,
  ...
  const updateBobject = async (bobject2, data2) => {
    try {
      await api.patch("/bobjects/" + bobject2?.id?.value + "/raw", data2);
      const newActiveBobject = await handleMutateAndRefresh();
      openExtendedScreen({
        ...context,
        bobject: newActiveBobject
      });
    } catch (e) {
      console.log(...oo_oo(`381802154_244_6_244_20_4`, e));
    }
  };
  const refreshBobject = () => {
    if (bobject && "salesforceId" in bobject && bobject.salesforceId) {
      ...
      api.get(`/utils/service/salesforce/resync/${sobjectType}/${sobjectId}`, {}).then(async () => {
        const newActiveBobject = await handleMutateAndRefresh();
        openExtendedScreen({
          ...context,
          bobject: newActiveBobject
  ...
  return /* @__PURE__ */ _jsxDEV("div", {
    ...
    children: dataModel && /* @__PURE__ */ _jsxDEV(_Fragment, {
      children: [/* @__PURE__ */ _jsxDEV("div", {
        className: styles.header,
        children: [/* @__PURE__ */ _jsxDEV(Text, {
          size: "m",
          weight: "bold",
          children: t("contactDetails")
        }, void 0, false, {
          fileName: _jsxFileName,
          lineNumber: 269,
          columnNumber: 13
        }, void 0), hasSalesforceIntegration && bobject && "salesforceId" in bobject && bobject.salesforceId && /* @__PURE__ */ _jsxDEV("div", {
          className: styles.refreshHelper,
          children: [/* @__PURE__ */ _jsxDEV(Text, {
            className: styles.refreshText,
            size: "xs",
            children: t("outdatedInfo")
          }, void 0, false, {
            fileName: _jsxFileName,
            lineNumber: 277,
            columnNumber: 19
        ...
        lineNumber: 268,
        columnNumber: 11
      }, void 0), sections?.map((section) => /* @__PURE__ */ _jsxDEV(_Fragment, {
        children: [/* @__PURE__ */ _jsxDEV("div", {
        ...
        }, `section-${section.title}`, false, {
          fileName: _jsxFileName,
          lineNumber: 298,
          columnNumber: 15
        }, void 0), (isLead ? section.leadFields : section.companyFields)?.map((field) => /* @__PURE__ */ _jsxDEV(SectionField, {
          value: bobject?.rawBobject[field?.id],
          name: field.name,
          activityAction: getContactAction(section.action, bobject?.rawBobject[field?.id]),
          onSubmit: (newValue) => updateBobject(bobject, {
            [field?.id]: newValue
          }),
          refresh: !refreshing,
          validation: section.validation(field)
        }, `field-${field?.id}`, false, {
          fileName: _jsxFileName,
          lineNumber: 304,
          columnNumber: 17
        }, void 0)), isLead && company && !isB2CAccount && /* @__PURE__ */ _jsxDEV(_Fragment, {
          children: [/* @__PURE__ */ _jsxDEV("div", {
            children: /* @__PURE__ */ _jsxDEV(Text, {
              size: "m",
              color: "softPeanut",
              className: styles.sectionSubHeader,
              children: section.companySection
            }, void 0, false, {
              fileName: _jsxFileName,
              lineNumber: 317,
              columnNumber: 21
            ...
            lineNumber: 316,
            columnNumber: 19
          }, void 0), section?.companyFields?.map((field) => /* @__PURE__ */ _jsxDEV(SectionField, {
            value: company?.rawBobject[field?.id],
            name: field.name,
            activityAction: getContactAction(section.action, company?.rawBobject[field?.id]),
            refresh: refreshing,
            onSubmit: (newValue) => updateBobject(company, {
              [field?.id]: newValue
            }),
            validation: section.validation(field)
          }, `field-${field?.id}`, false, {
...
_s(BobjectDetail, "LKVMlZwraqs1tSDvns9Gb2G3aDE=", true, function() {
  return [useTranslation, useExtensionContext, useContextBobjects, useDialerLauncher, useMinimizableModals, useBaseSetEmailVariablesValues, useDataModel, useAircallPhoneLinkEnabled];
});
_c = BobjectDetail;
;
function oo_cm() {
