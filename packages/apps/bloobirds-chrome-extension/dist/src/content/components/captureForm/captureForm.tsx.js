import { createHotContext as __vite__createHotContext } from "/vendor/vite-client.js";import.meta.hot = __vite__createHotContext("/src/content/components/captureForm/captureForm.tsx.js");import RefreshRuntime from "/vendor/react-refresh.js";
let prevRefreshReg;
let prevRefreshSig;
if (import.meta.hot) {
  ...
  window.$RefreshReg$ = (type, id) => {
    RefreshRuntime.register(type, "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/captureForm/captureForm.tsx " + id);
  };
  window.$RefreshSig$ = RefreshRuntime.createSignatureFunctionForTransform;
}
var _jsxFileName = "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/captureForm/captureForm.tsx", _s = $RefreshSig$(), _s2 = $RefreshSig$();
...
import { FormField } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-bobjects-src-index.tsx.js";
import { Button } from "/vendor/.vite-deps-@bloobirds-it_flamingo-ui.js__v--2cc8757f.js";
import { useActiveAccountId, useObjectCreationSettings, useUserHelpers } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-src-index.tsx.js";
import { LEAD_FIELDS_LOGIC_ROLE, MIXPANEL_EVENTS, UserHelperKeys } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-src-index.ts.js";
import { getExtensionBobjectByIdFields, api } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js";
import { isAxiosError } from "/vendor/.vite-deps-axios.js__v--7363e4a1.js";
...
import { scrapLeadCompanyName, scrapLeadFirstName, scrapLeadJobTitle, scrapLeadLastName } from "/src/utils/scrapper/profileScrapper.ts.js";
...
import DuplicatedLead from "/src/content/components/duplicatedLead/duplicatedLead.tsx.js";
...
const useLeadFields = () => {
  ...
  const {
    data
  } = useSWR(isLoggedIn ? "/linkedin/settings/layout" : null, fetchLeadFields);
  return data?.fields ?? [];
};
_s(useLeadFields, "XoZuKWZZN0ORR52VIm6HCoCak30=", false, function() {
...
const CaptureForm = ({
  ...
  const [duplicatedLead, setDuplicatedLead] = useState(null);
  const [duplicatedField, setDuplicatedField] = useState(null);
  ...
  useEffect(() => {
    if (fields.length > 0) {
      ...
      const lastNameField = fields.find((field) => field.logicRole === LEAD_FIELDS_LOGIC_ROLE.SURNAME);
      const jobTitleField = fields.find((field) => field.logicRole === LEAD_FIELDS_LOGIC_ROLE.JOB_TITLE);
  ...
  useEffect(() => {
    if (duplicatedLead) {
      ...
      promise.then(({
        data
      }) => setTransformedBobject(data)).catch((e) => console.log(...oo_oo(`1958150926_171_73_171_87_4`, e)));
    }
  }, [duplicatedLead]);
  useEffect(() => setGoBack(() => {
    setDuplicatedLead(void 0);
    setDuplicatedField(void 0);
  }), []);
      ...
      if (info) {
        ...
        response = await api.post("/linkedin/leads", {
          fields: {
            ...
            LEAD__SALES_NAVIGATOR_URL: salesNavigatorURL ?? void 0
          },
          companyName: data.companyName,
          createCompany: data.createCompany
        });
  ...
  if (duplicatedLead) {
    if (leadInfo) {
      return /* @__PURE__ */ _jsxDEV(LeadPage, {
        lead: leadInfo
      }, void 0, false, {
    ...
    return /* @__PURE__ */ _jsxDEV(DuplicatedLead, {
      linkedInURL,
      salesNavigatorURL,
      lead: transformedBobject,
  ...
  return /* @__PURE__ */ _jsxDEV(BubbleWindow, {
    children: leadInfo ? /* @__PURE__ */ _jsxDEV(_Fragment, {
      children: /* @__PURE__ */ _jsxDEV(LeadPage, {
        lead: leadInfo
      }, leadInfo?.id, false, {
        fileName: _jsxFileName,
        lineNumber: 265,
      ...
      children: [/* @__PURE__ */ _jsxDEV(BubbleWindowHeader, {
        ...
        children: /* @__PURE__ */ _jsxDEV("form", {
          children: fields?.reduce((acc, curr) => {
        ...
        children: /* @__PURE__ */ _jsxDEV(Button, {
          expand: true,
          disabled: Object.keys(errors).length !== 0 || isSubmitting || companyRequiredFromExtension && !createCompany && !companyId,
...
_s2(CaptureForm, "hrBZIpHHBKQY3+sl1YWnHQlOoYo=", true, function() {
  return [useTranslation, useExtensionContext, useFloatingMenuContext, useLeadFields, useCreationForm, useUserHelpers, useObjectCreationSettings, useForm];
});
_c = CaptureForm;
