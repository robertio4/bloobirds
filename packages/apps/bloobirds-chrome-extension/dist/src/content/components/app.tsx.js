import { createHotContext as __vite__createHotContext } from "/vendor/vite-client.js";import.meta.hot = __vite__createHotContext("/src/content/components/app.tsx.js");import RefreshRuntime from "/vendor/react-refresh.js";
let prevRefreshReg;
let prevRefreshSig;
if (import.meta.hot) {
  ...
  window.$RefreshReg$ = (type, id) => {
    RefreshRuntime.register(type, "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/app.tsx " + id);
  };
  window.$RefreshSig$ = RefreshRuntime.createSignatureFunctionForTransform;
}
var _jsxFileName = "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/app.tsx", _s = $RefreshSig$(), _s2 = $RefreshSig$();
import __vite__cjsImport2_react from "/vendor/.vite-deps-react.js__v--2922b7f0.js"; const useEffect = __vite__cjsImport2_react["useEffect"]; const useState = __vite__cjsImport2_react["useState"]; const Suspense = __vite__cjsImport2_react["Suspense"];
import { SkipTaskModal } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-bobjects-src-index.tsx.js";
import { Confetti } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-confetti-src-index.tsx.js";
import { ToastContainer } from "/vendor/.vite-deps-@bloobirds-it_flamingo-ui.js__v--2cc8757f.js";
import { useActiveUserSettings, useDataModel, useLocalStorage, useRawAccountSettings, useSessionStorage, useWhatsappEnabled, useNotificationRemindersEnabled, useSWRLifespanEnabled } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-src-index.tsx.js";
import { useInternationalizationSettings } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-internationalization-src-index.tsx.js";
import { usePlover } from "/vendor/.vite-deps-@bloobirds-it_plover.js__v--88b8fafa.js";
import { QuickLogModal } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-quickLogModal-dist-index.js.js";
import { ExtensionHelperKeys, MessagesEvents, SessionStorageKeys, UserRole } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-src-index.ts.js";
import { getTokenEncoded, isLoggedIn, logout, isElementLoaded, isWhatsAppPage, isSalesforcePage, isDynamicsPage } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js";
import { WIZARD_SOURCES, WizardProvider } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-wizardModalContext-dist-index.js.js";
import { WizardModalFactory } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-wizardModalController-dist-index.js.js";
...
import { mutate, SWRConfig } from "/vendor/.vite-deps-swr.js__v--ed0a962e.js";
import { ApiHosts } from "/src/misc/api/ApiHosts.ts.js";
import { shouldInjectSalesforce } from "/src/utils/url.ts.js";
import { AircallEventListener } from "/src/content/components/aircallEventListener/aircallEventListener.tsx.js";
import { BubbleWrapper } from "/src/content/components/bubbleWrapper/bubbleWrapper.tsx.js";
import { BulkActionsToasts } from "/src/content/components/bulkActionsToasts/bulkActionsToasts.tsx.js";
import { fetchLeadFields } from "/src/content/components/captureForm/captureForm.tsx.js";
import { ExtensionProvider } from "/src/content/components/context.tsx.js";
import DynamicsObserver from "/src/content/components/dynamicsObserver/dynamicsObserver.tsx.js";
import ExtensionLeftBar from "/src/content/components/extensionLeftBar/extensionLeftBar.tsx.js";
import { getBellSelector, getSelector } from "/src/content/components/extensionLeftBar/extensionLeftBar.utils.tsx.js";
import { ExtensionLeftBarProvider } from "/src/content/components/extensionLeftBar/extensionLeftBarContext.tsx.js";
import { ErrorHandler } from "/src/content/components/floatingMenu/components/errorBoundary.tsx.js";
import GeneralSearchBarWrapper from "/src/content/components/generalSearchBar/generalSearchBarWrapper.tsx.js";
import LittleBsInjector from "/src/content/components/idShortcuts/LittleBsInjector.tsx.js";
import { NotificationReminders } from "/src/content/components/notificationReminders/notificationReminders.tsx.js";
import { NotificationsWrapper } from "/src/content/components/notificationsWrapper/notificationsWrapper.tsx.js";
import { staleCacheKeysMiddleware } from "/src/content/components/swrTimestampMiddleware.tsx.js";
import SyncListButtonDynamics from "/src/content/components/syncDynamicsLists/syncListButton.tsx.js";
import SyncListButton from "/src/content/components/syncSalesforceLists/syncListButton.tsx.js";
import WhatsappRenderer from "/src/content/components/whatsappRenderer/WhatsappRenderer.tsx.js";
...
export function isAuth(hostname) {
  return hostname === "localhost" || hostname === "auth.bloobirds.com" || hostname === "auth.dev-bloobirds.com";
}
const App = () => {
  _s();
  const {
  ...
  const {
    settings
  } = useActiveUserSettings(loggedIn);
  ...
  const dataModel = useDataModel(settings && `/utils/service/datamodel/extension/${settings?.user?.id}`, loggedIn);
  const {
    getRawAccountSetting
  ...
  if ("development" === "production" && user?.id) {
    ...
    const isSalesforcePage2 = window.location.href?.match("^.*://.*.lightning.force.com.*");
    mixpanel.register({
      from_chrome_extension: true,
      from_linkedin: isLinkedinPage,
      from_salesforce: !!isSalesforcePage2,
      source: isLinkedinPage ? "linkedin" : isSalesforcePage2 ? "salesforce" : "other"
    });
  ...
  useEffect(() => {
    const callBack = (event) => {
      ...
      if (event.data.type && event.data.type === "FROM_AUTH") {
        console.log(...oo_oo(`3919981067_163_8_163_43_4`, "Login event received"));
      ...
      if (event.data.type && event.data.type === "FROM_AUTH_LOGOUT") {
        console.log(...oo_oo(`3919981067_170_8_170_44_4`, "Logout event received"));
        logout();
      }
    };
  ...
  useEffect(() => {
    const callBack = (event) => {
      localStorage.setItem("test", `Received message ${event.data}`);
      if (event.source !== window) {
        return;
      }
      if (event.data.type && event.data.type === "GO_TO_ACTIVITY") {
        chrome?.storage?.sync?.set({
  ...
  useEffect(() => {
    if (loggedIn) {
      isElementLoaded(getBellSelector()).then(() => {
        ...
        const referenceElement = isSalesforcePage(url) ? document.getElementsByClassName("slds-global-actions__item slds-grid")[0] : isDynamicsPage(url) ? document.querySelector('#topBar ul[data-id="CommandBar"]') : document.getElementsByClassName("global-nav__primary-item")[5];
  ...
  useEffect(() => {
    fetchLeadFields("/linkedin/settings/layout").then((result) => mutate("/linkedin/settings/layout", result));
  }, []);
  ...
  if (isSalesforcePage(url) && salesforceInstance && !url.includes(salesforceInstance.replace("my.salesforce.com", ""))) {
    return null;
  }
  const activeBobjectListeners = {
    Company: /* @__PURE__ */ new Set(),
    Lead: /* @__PURE__ */ new Set(),
    Opportunity: /* @__PURE__ */ new Set(),
    Task: /* @__PURE__ */ new Set(),
    Activity: /* @__PURE__ */ new Set(),
    Product: /* @__PURE__ */ new Set(),
    OpportunityProduct: /* @__PURE__ */ new Set()
  };
  ...
  return /* @__PURE__ */ _jsxDEV(ExtensionProvider, {
    ...
    children: /* @__PURE__ */ _jsxDEV(SWRConfig, {
      ...
      children: /* @__PURE__ */ _jsxDEV(RecoilRoot, {
        children: /* @__PURE__ */ _jsxDEV(PloverWrapper, {
          loggedIn,
          children: /* @__PURE__ */ _jsxDEV(WizardProvider, {
            value: initialWizardContext,
            children: !isAuthPage && /* @__PURE__ */ _jsxDEV(Suspense, {
              fallback: /* @__PURE__ */ _jsxDEV(_Fragment, {}, void 0, false),
              children: [/* @__PURE__ */ _jsxDEV(Confetti, {}, void 0, false, {
                fileName: _jsxFileName,
                lineNumber: 315,
                columnNumber: 19
              }, void 0), /* @__PURE__ */ _jsxDEV(ToastContainer, {}, void 0, false, {
                fileName: _jsxFileName,
                lineNumber: 316,
                columnNumber: 19
              }, void 0), /* @__PURE__ */ _jsxDEV(ErrorHandler, {
                children: [canShowBell && /* @__PURE__ */ _jsxDEV(GeneralSearchBarWrapper, {}, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 318,
                  columnNumber: 37
                }, void 0), /* @__PURE__ */ _jsxDEV(ExtensionLeftBarProvider, {
                  children: [canShowLeftBar && /* @__PURE__ */ _jsxDEV(ExtensionLeftBar, {
                    url
                  }, void 0, false, {
                    fileName: _jsxFileName,
                    lineNumber: 320,
                    columnNumber: 42
                  }, void 0), canShowBell && /* @__PURE__ */ _jsxDEV(NotificationsWrapper, {}, void 0, false, {
                    fileName: _jsxFileName,
                    lineNumber: 321,
                    columnNumber: 39
                  }, void 0), canShowBell && isDynamicsPage && /* @__PURE__ */ _jsxDEV(SyncListButtonDynamics, {}, url, false, {
                    fileName: _jsxFileName,
                    lineNumber: 322,
                    columnNumber: 57
                  }, void 0), canShowBell && /* @__PURE__ */ _jsxDEV(BulkActionsToasts, {}, void 0, false, {
                    fileName: _jsxFileName,
                    lineNumber: 323,
                    columnNumber: 39
                  }, void 0), /* @__PURE__ */ _jsxDEV(LittleBsInjector, {}, void 0, false, {
                    fileName: _jsxFileName,
                    lineNumber: 324,
                    columnNumber: 23
                  }, void 0), canShowBell && /* @__PURE__ */ _jsxDEV(SyncListButton, {}, "syncListButton" + url, false, {
                    fileName: _jsxFileName,
                    lineNumber: 325,
                    columnNumber: 39
                  }, void 0), canWhatsappRenderer && /* @__PURE__ */ _jsxDEV(WhatsappRenderer, {}, void 0, false, {
                    fileName: _jsxFileName,
                    lineNumber: 326,
                    columnNumber: 47
                  }, void 0), isDynamicsPage && /* @__PURE__ */ _jsxDEV(DynamicsObserver, {}, void 0, false, {
                    fileName: _jsxFileName,
                    lineNumber: 327,
                    columnNumber: 42
                  }, void 0)]
                  ...
                  lineNumber: 319,
                  columnNumber: 21
                }, void 0), /* @__PURE__ */ _jsxDEV(BubbleWrapper, {}, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 329,
                  columnNumber: 21
                }, void 0), /* @__PURE__ */ _jsxDEV(SkipTaskModal, {}, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 330,
                  columnNumber: 21
                }, void 0), canShowBell && /* @__PURE__ */ _jsxDEV(QuickLogModal, {}, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 331,
                  columnNumber: 37
                }, void 0), canShowBell && hasNotificationRemindersEnabled && /* @__PURE__ */ _jsxDEV(NotificationReminders, {}, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 332,
                  columnNumber: 72
                }, void 0), canShowBell && /* @__PURE__ */ _jsxDEV(AircallEventListener, {}, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 333,
                  columnNumber: 37
                }, void 0), /* @__PURE__ */ _jsxDEV(WizardModalFactory, {}, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 334,
                  columnNumber: 21
                }, void 0)]
...
_s(App, "2MAn9VuX6eMaXcRrvzz+yOAdL2s=", false, function() {
  return [useSessionStorage, useLocalStorage, useActiveUserSettings, useDataModel, useRawAccountSettings, useWhatsappEnabled, useSWRLifespanEnabled, useNotificationRemindersEnabled, useInternationalizationSettings];
});
_c = App;
const PloverWrapper = ({
  children,
