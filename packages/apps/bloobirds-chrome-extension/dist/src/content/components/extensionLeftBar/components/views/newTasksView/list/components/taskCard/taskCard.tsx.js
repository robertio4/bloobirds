import { createHotContext as __vite__createHotContext } from "/vendor/vite-client.js";import.meta.hot = __vite__createHotContext("/src/content/components/extensionLeftBar/components/views/newTasksView/list/components/taskCard/taskCard.tsx.js");import RefreshRuntime from "/vendor/react-refresh.js";
let prevRefreshReg;
let prevRefreshSig;
if (import.meta.hot) {
  ...
  window.$RefreshReg$ = (type, id) => {
    RefreshRuntime.register(type, "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/extensionLeftBar/components/views/newTasksView/list/components/taskCard/taskCard.tsx " + id);
  };
  window.$RefreshSig$ = RefreshRuntime.createSignatureFunctionForTransform;
}
var _jsxFileName = "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/extensionLeftBar/components/views/newTasksView/list/components/taskCard/taskCard.tsx", _s = $RefreshSig$();
...
import __vite__cjsImport8_lodash_startCase from "/vendor/.vite-deps-lodash_startCase.js__v--9bd8a96d.js"; const startCase = __vite__cjsImport8_lodash_startCase.__esModule ? __vite__cjsImport8_lodash_startCase.default : __vite__cjsImport8_lodash_startCase;
...
import { TaskIcons, ExtraFields, BobjectNames, TaskAsignee, TaskDate } from "/src/content/components/extensionLeftBar/components/views/newTasksView/list/components/taskCard/components/index.ts.js";
...
import { TaskButtons } from "/src/content/components/extensionLeftBar/components/views/newTasksView/list/components/taskCard/components/taskButtons/taskButtons.tsx.js";
...
export function TaskCard({
  ...
  const onCardClick = async () => {
    ...
    if (!leadId && !companyId && !opportunityId) {
      setCurrentTask(taskForm?.data);
      setTaskId(bobjectId);
    } else {
      const contactViewId = leadId ? leadId : isB2CAccount ? b2cOrder : b2bOrder;
  ...
  return /* @__PURE__ */ _jsxDEV(_Fragment, {
    children: [/* @__PURE__ */ _jsxDEV(motion.div, {
      ...
      children: [/* @__PURE__ */ _jsxDEV("div", {
        ...
        lineNumber: 190,
        columnNumber: 9
      }, this), (isHovering || isProcessing) && /* @__PURE__ */ _jsxDEV(TaskButtons, {
        parentRef: ref,
        task,
...
_s(TaskCard, "/+ihRYPS7MWiBlFyy5nFnyUYMYE=", false, function() {
  return [useHover, useIsB2CAccount, useExtensionContext, useTaskFeedContext, useTranslation];
});
_c = TaskCard;
;
function oo_cm() {
