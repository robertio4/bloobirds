import { createHotContext as __vite__createHotContext } from "/vendor/vite-client.js";import.meta.hot = __vite__createHotContext("/src/content/components/linkedInScreens/profileForm.tsx.js");import RefreshRuntime from "/vendor/react-refresh.js";
let prevRefreshReg;
let prevRefreshSig;
if (import.meta.hot) {
  ...
  window.$RefreshReg$ = (type, id) => {
    RefreshRuntime.register(type, "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/linkedInScreens/profileForm.tsx " + id);
  };
  window.$RefreshSig$ = RefreshRuntime.createSignatureFunctionForTransform;
}
var _jsxFileName = "/Users/robertorf/Workspace/frontend-monorepo/packages/apps/bloobirds-chrome-extension/src/content/components/linkedInScreens/profileForm.tsx", _s = $RefreshSig$();
...
import { useObjectCreationSettings, useSalesforceLeftBarEnabled } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-src-index.tsx.js";
...
import { api, isIdLinkedinUrl, isLinkedInProfilePage, isSalesNavigatorProfile, isDynamicsPage } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js";
import __vite__cjsImport6_asyncRetry from "/vendor/.vite-deps-async-retry.js__v--e779a1d8.js"; const retry = __vite__cjsImport6_asyncRetry.__esModule ? __vite__cjsImport6_asyncRetry.default : __vite__cjsImport6_asyncRetry;
import { useCreationForm } from "/src/hooks/useCreationForm.ts.js";
import { searchLeadByQuery } from "/src/utils/leads.ts.js";
import { getLinkedInUrlFromSalesProfile } from "/src/utils/salesUrlConverter.ts.js";
import { scrapLeadCompanyName, scrapLeadFullName, scrapLeadLinkedinId } from "/src/utils/scrapper/profileScrapper.ts.js";
import CaptureForm from "/src/content/components/captureForm/captureForm.tsx.js";
...
import CaptureLinkFailed from "/src/content/components/linkedInScreens/captureLinkFailed.tsx.js";
import LeadPage from "/src/content/components/linkedInScreens/leadPage.tsx.js";
import MultipleLeadsPage from "/src/content/components/linkedInScreens/multipleLeadsPage.tsx.js";
import NeedsSalesNavigatorUpgrade from "/src/content/components/linkedInScreens/needsSalesNavigatorUpgrade.tsx.js";
...
function ProfileForm({
  ...
  const linkedInIdFieldId = dataModel.findFieldByLogicRole(LEAD_FIELDS_LOGIC_ROLE.LEAD__LINKEDIN_ID)?.id;
  const refresh = () => {
    ...
    if (!currentPage) {
      ...
      api.get(`/linkedin/leads/dynamics/${info.entity}/${info.id}`).then((data2) => {
        ...
        if (data2.data) {
          ...
          setTimeout(() => {
            ...
            setIsLoading(false);
            if (refetch) {
              api.get(`/linkedin/leads/dynamics/${info.entity}/${info.id}`).then((dataWithRelated) => {
                setIsLoading(true);
                if (dataWithRelated.data) {
                  setExactMatch(true);
                  setActiveBobject(dataWithRelated.data);
                  setCurrentLeadOrLeads([dataWithRelated.data]);
                }
              });
            }
          }, 6e3);
        } else {
          setCurrentPage(window.location.origin);
      ...
      setSalesNavigatorURL("");
      setLinkedInURL("");
      api.post(`/bobjects/${settings?.account?.id}/global-search`, {
        query: info?.name,
        bobjectTypes: ["Lead"],
        numberOfResults: 20
      }).then((response) => {
      ...
      retry(async () => getLinkedInUrlFromSalesProfile(currentPage), {
        ...
        setLinkedInURL(url);
        const fullName2 = scrapLeadFullName();
        const companyName = scrapLeadCompanyName();
        searchLeadByQuery({
          linkedInUrl: isIdLinkedinUrl(url) ? null : url || null,
          salesNavigatorUrl: currentPage,
          leadFullName: fullName2?.trim() ? fullName2 : null,
          companyName: companyName?.trim() ? companyName : null,
          autoMatching: true
        }).then((data) => {
          setCurrentLeadOrLeads(data?.leads);
          ...
          console.log(...oo_oo(`3531355688_188_14_188_30_4`, err));
          console.error("Error searching for lead by sales navigator");
          setIsLoading(false);
        });
      }).catch((err) => {
        console.log(...oo_oo(`3531355688_194_10_194_26_4`, err));
  ...
  if (createLead && enabledObjectCreation) {
    return /* @__PURE__ */ _jsxDEV(CaptureForm, {
      currentPage,
      linkedInURL,
      salesNavigatorURL,
  ...
  return /* @__PURE__ */ _jsxDEV(_Fragment, {
    children: isLoading ? /* @__PURE__ */ _jsxDEV(Loading, {}, void 0, false, {
      ...
      lineNumber: 248,
      columnNumber: 9
    }, this) : needsUpgrade ? /* @__PURE__ */ _jsxDEV(NeedsSalesNavigatorUpgrade, {}, void 0, false, {
      fileName: _jsxFileName,
      lineNumber: 250,
      columnNumber: 9
    }, this) : errorCapturingUrl ? /* @__PURE__ */ _jsxDEV(CaptureLinkFailed, {
      onRefresh: refresh
    }, void 0, false, {
      fileName: _jsxFileName,
      lineNumber: 252,
      columnNumber: 9
    }, this) : enabledObjectCreation && currentLeadOrLeads && (currentLeadOrLeads?.length > 1 || !exactMatch) ? /* @__PURE__ */ _jsxDEV(MultipleLeadsPage, {
      ...
      lineNumber: 256,
      columnNumber: 9
    }, this) : currentLeadOrLeads && currentLeadOrLeads?.length === 1 && currentLeadOrLeads[0]?.id ? isSalesforceLeftBarEnabled ? /* @__PURE__ */ _jsxDEV(ContactView, {
      defaultContext: initialLeadContext
    }, void 0, false, {
      fileName: _jsxFileName,
      lineNumber: 268,
      columnNumber: 11
    }, this) : /* @__PURE__ */ _jsxDEV(LeadPage, {
      lead: currentLeadOrLeads[0]
    }, void 0, false, {
      fileName: _jsxFileName,
      lineNumber: 270,
      columnNumber: 11
    }, this) : enabledObjectCreation ? /* @__PURE__ */ _jsxDEV(CaptureForm, {
      currentPage,
      linkedInURL,
      salesNavigatorURL,
      setCurrentLead: setCurrentLeadOrLeads,
      ...
      lineNumber: 273,
      columnNumber: 9
    }, this) : /* @__PURE__ */ _jsxDEV(NoContextPage, {}, void 0, false, {
      fileName: _jsxFileName,
      lineNumber: 282,
      columnNumber: 9
    }, this)
...
_s(ProfileForm, "YetJPQJFHD/yjpf8paQ1Hq5Um/4=", false, function() {
  return [useExtensionContext, useGetCurrentPage, useGetSettings, useGetDataModel, useCreationForm, useObjectCreationSettings, useGetSidePeekEnabled, useSalesforceLeftBarEnabled];
});
_c = ProfileForm;
