...
import { api, getFieldTextById } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js";
import { atom, useRecoilState, useRecoilValue, useSetRecoilState } from "/vendor/.vite-deps-recoil.js__v--5937b302.js";
      ...
      if (opportunity) {
        if (opportunity.raw) {
          ...
          if (variable.fieldType.includes("PICKLIST")) {
            ...
            return opportunity[variable.id];
        }
      } else
        return null;
    case "user":
...
export const fetchBobjectFields = async (url) => {
  try {
