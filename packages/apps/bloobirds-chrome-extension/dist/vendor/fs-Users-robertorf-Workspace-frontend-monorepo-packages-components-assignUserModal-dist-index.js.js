...
import { useToasts, Modal, ModalHeader, ModalTitle, Select, Icon, Item, CircularBadge, Text, Callout, ModalFooter, Button, Spinner, Dropdown, RadioGroup, Radio } from '/vendor/.vite-deps-@bloobirds-it_flamingo-ui.js__v--2cc8757f.js';
import { useSelectAll, useBobject, useFullSalesEnabled, useUserSearch } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-dist-index.js.js';
import { api, isOpportunity, getValueFromLogicRole } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js';
import { BobjectTypes, ACTIVITY_FIELDS_LOGIC_ROLE, FIELDS_LOGIC_ROLE, IMPORT_THRESHOLD, BulkActions, MIXPANEL_EVENTS, LEAD_FIELDS_LOGIC_ROLE, COMPANY_FIELDS_LOGIC_ROLE } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-dist-index.js.js';
...
var styles = {
  "_content__wraper": "assignUser-module__content__wraper__I7ue8",
  "_info__wrapper": "assignUser-module__info__wrapper__uV-fg",
  "_autocomplete__wrapper": "assignUser-module__autocomplete__wrapper__HlP3M",
  "_confirm__button": "assignUser-module__confirm__button__OEzRt",
  "_circularBadge": "assignUser-module__circularBadge__PGr0L",
  "_content__assign": "assignUser-module__content__assign__d1x-a",
  "_checkbox": "assignUser-module__checkbox__4Gvm5",
  "_assign_button_wrapper": "assignUser-module__assign_button_wrapper__vTtvD",
  "_dropdown_content__wraper": "assignUser-module__dropdown_content__wraper__bqgpL",
  "_title_content__wraper": "assignUser-module__title_content__wraper__Fy6Js",
  "_dropdown_button_wrapper": "assignUser-module__dropdown_button_wrapper__5Rvmo",
  "_dropdown_autocomplete__wrapper": "assignUser-module__dropdown_autocomplete__wrapper__C6VQk"
};
...
_s2(useAssignUser, "OCgh0HGEp65P4AcrYdotSAWfx08=", false, function () {
  return [useSelectAll, useBobject, useTranslation, useToasts];
});
...
_s3(AssignUserModal, "7vKGPW1xxgvgDKmoTgxUixPAJUY=", false, function () {
  return [useFullSalesEnabled, useAssignUser, useUserSearch, useTranslation];
});
_c = AssignUserModal;
...
var AssignUserDropdown = /*#__PURE__*/_s4(React.forwardRef(_c2 = _s4(function (_ref, ref) {
  _s4();
  var bobject = _ref.bobject,
    accountId = _ref.accountId,
    userId = _ref.userId,
...
}, "e4p5lHkMf/lDmE34GaunI2Z6klQ=", false, function () {
  return [useAssignUser, useTranslation];
})), "e4p5lHkMf/lDmE34GaunI2Z6klQ=", false, function () {
  return [useAssignUser, useTranslation];
});
_c3 = AssignUserDropdown;
...
var SearchAssignUserDropdown = /*#__PURE__*/_s5(React.forwardRef(_c4 = _s5(function (_ref, ref) {
  _s5();
  var _sampleBobject$id, _t, _users$users;
  var bobject = _ref.bobject,
    accountId = _ref.accountId,
...
}, "6TjhOqrnXJ6MKzKge7MUzbfZv4Y=", false, function () {
  return [useAssignUser, useTranslation, useUserSearch, useFullSalesEnabled];
})), "6TjhOqrnXJ6MKzKge7MUzbfZv4Y=", false, function () {
  return [useAssignUser, useTranslation, useUserSearch, useFullSalesEnabled];
});
_c5 = SearchAssignUserDropdown;
export { AssignUserDropdown, AssignUserModal, SearchAssignUserDropdown };
var _c, _c2, _c3, _c4, _c5;
$RefreshReg$(_c, "AssignUserModal");
$RefreshReg$(_c2, "AssignUserDropdown$React.forwardRef");
$RefreshReg$(_c3, "AssignUserDropdown");
$RefreshReg$(_c4, "SearchAssignUserDropdown$React.forwardRef");
$RefreshReg$(_c5, "SearchAssignUserDropdown");
if (import.meta.hot) {
