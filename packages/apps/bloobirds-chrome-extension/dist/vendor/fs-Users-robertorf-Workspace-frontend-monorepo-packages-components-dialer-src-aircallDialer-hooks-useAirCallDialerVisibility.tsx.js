import { createHotContext as __vite__createHotContext } from "/vendor/vite-client.js";import.meta.hot = __vite__createHotContext("/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-dialer-src-aircallDialer-hooks-useAirCallDialerVisibility.tsx.js");import RefreshRuntime from "/vendor/react-refresh.js";
let prevRefreshReg;
let prevRefreshSig;
if (import.meta.hot) {
  ...
  window.$RefreshReg$ = (type, id) => {
    RefreshRuntime.register(type, "/Users/robertorf/Workspace/frontend-monorepo/packages/components/dialer/src/aircallDialer/hooks/useAirCallDialerVisibility.tsx " + id);
  };
  window.$RefreshSig$ = RefreshRuntime.createSignatureFunctionForTransform;
}
var _jsxFileName = "/Users/robertorf/Workspace/frontend-monorepo/packages/components/dialer/src/aircallDialer/hooks/useAirCallDialerVisibility.tsx", _s = $RefreshSig$(), _s2 = $RefreshSig$(), _s3 = $RefreshSig$();
...
import { useActiveAccountId, useOtoUpdateContactId } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-dist-index.js.js";
...
import AirCallDialer from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-dialer-src-aircallDialer-airCallDialerFrame.tsx.js";
import AircallPhone from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-dialer-src-aircallDialer-hooks-aircallDialer.js.js";
...
export const AircallDialer = () => {
  ...
  const {
    data: activity
  } = useSWR(callId ? `/calls/aircall/calls/${callId}` : null, async (url) => {
  ...
  const createCallAndLaunchCCF = async (details) => {
    const {
      data: activity2
    } = await api.post("/calls/aircall/calls/" + details?.call_id + "/end");
    if (activity2) {
      api.get(`/bobjects/${activity2?.activity?.value}/form?injectReferences=true`).then((response) => {
        if (response?.data) {
  ...
  const aircallPhoneExt = useMemo(() => {
    ...
    if (ref.current) {
      try {
        ...
        console.log(...oo_oo(`2219653713_180_8_180_22_4`, e));
      }
    }
    return null;
  }, [ref.current, launch]);
    ...
    if (dialedPhoneNumber) {
      if (isSalesforcePage(normalizeUrl(window.location.href))) {
        ...
        if (possibleCti) {
          possibleCti.remove();
          setTimeout(
            aircallPhoneExt?.send("dial_number", {
  ...
  return /* @__PURE__ */ _jsxDEV(AircallContext.Provider, {
    value: {
      aircallPhoneExt,
      launch,
      setLaunch,
    ...
    children: /* @__PURE__ */ _jsxDEV(_Fragment, {
      children: [/* @__PURE__ */ _jsxDEV(AirCallDialer, {
        ref
      }, void 0, false, {
        fileName: _jsxFileName,
        lineNumber: 224,
        columnNumber: 9
      }, void 0), showCorrectContactFlow && activityCCF && (mainActivityBobject || hasOtoUpdateContactId) && openWizard(WIZARD_MODALS.CONTACT_FLOW_OTO, activityCCF, {
...
_s(AircallDialer, "j1612VBrjRFxXNV7tVe1mU6aUpI=", false, function() {
  return [useDialer, useDialerStore, useWizardContext, useActiveAccountId, useOtoUpdateContactId, useSWR];
});
_c = AircallDialer;
...
_s2(useAircallDialer, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
...
_s3(useAirCallDialerVisibility, "y5ZAMNCpP7lIkhF7A6aU/hEeGyo=", false, function() {
