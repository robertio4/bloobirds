...
} from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-src-routes.ts.js";
import { UserHelperKeys } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-src-userHelperKeys.ts.js";
export const getAdminQuickStartGuideBlocks = (hasCadencePermission, cadencesV2Enabled, params) => [
  {
  ...
  },
  {
    ...
    goals: [
      ...
      },
      {
        ...
        linkNavigation: params?.READY_TO_LINKEDIN?.hasExtension ? "https://www.linkedin.com/in/tonipereznavarro/" : "https://chrome.google.com/webstore/detail/bloobirds/bfnmjliageccndnbpoadbigbnhicogbh"
      },
      {
        ...
        linkNavigation: params?.READY_TO_LINKEDIN?.hasExtension ? `${APP_TASKS_INBOX}/linkedin` : "https://chrome.google.com/webstore/detail/bloobirds/bfnmjliageccndnbpoadbigbnhicogbh"
      },
      {
