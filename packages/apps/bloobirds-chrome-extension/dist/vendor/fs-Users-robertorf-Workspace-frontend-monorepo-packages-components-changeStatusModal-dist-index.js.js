import __vite__cjsImport0_react from "/vendor/.vite-deps-react.js__v--2922b7f0.js"; const useState = __vite__cjsImport0_react["useState"]; const createContext = __vite__cjsImport0_react["createContext"]; const useContext = __vite__cjsImport0_react["useContext"]; const useRef = __vite__cjsImport0_react["useRef"]; const useEffect = __vite__cjsImport0_react["useEffect"];
import { useTranslation, Trans } from '/vendor/.vite-deps-react-i18next.js__v--8418bf92.js';
import { Text, Select, Item, Label, Modal, ModalHeader, ModalTitle, Icon, ModalContent, ModalSection, ModalFooter, Button, Spinner } from '/vendor/.vite-deps-@bloobirds-it_flamingo-ui.js__v--2cc8757f.js';
import { api, removeScrollOfBox, recoverScrollOfBox } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js';
import { FIELDS_LOGIC_ROLE, CRM } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-dist-index.js.js';
import clsx from '/vendor/.vite-deps-clsx.js__v--07c00239.js';
import { useStatus } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-dist-index.js.js';
...
import { OPPORTUNITY_STATUS_LOGIC_ROLE } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-src-index.ts.js';
