...
import { AssignedToSelector, BobjectSelector, useConfirmDeleteModal } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-bobjects-dist-index.js.js';
import { Label, Icon, useVisible, Dropdown, Text, Section, Button, DatePicker, Tooltip, IconButton, Spinner, useToasts, Modal, ModalHeader, ModalTitle, ModalCloseIcon } from '/vendor/.vite-deps-@bloobirds-it_flamingo-ui.js__v--2cc8757f.js';
import { useDataModel, useActiveAccountId, useNewCadenceTableEnabled, useCustomTasks, useActiveUserSettings, useReminders, useMinimizableModal, useUserHelpers, useAddToCalendar } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-dist-index.js.js';
...
var styles$4 = {
  "container": "prioritySelector-module_container__3T8nC",
  "containerOpen": "prioritySelector-module_containerOpen__NBAgB"
};
...
_s2(PrioritySelector, "+Rh5Rd2vR2eZgTVSEPxv2OGtYdk=", false, function () {
  return [useDataModel];
});
_c = PrioritySelector;
...
var styles$3 = {
  "container": "taskTypeSelector-module_container__K6Hx3",
  "item": "taskTypeSelector-module_item__hh9kC",
  "icon": "taskTypeSelector-module_icon__3nEeU",
  "title": "taskTypeSelector-module_title__v-9gN",
  "taskButton": "taskTypeSelector-module_taskButton__R9tXB",
  "iconContainer": "taskTypeSelector-module_iconContainer__SGxCU",
  "iconContainer_long": "taskTypeSelector-module_iconContainer_long__sDZDI",
  "add_new_custom_task": "taskTypeSelector-module_add_new_custom_task__ZCK-a",
  "footer": "taskTypeSelector-module_footer__9Z-95"
};
...
var styles$2 = {
  "container": "taskForm-module_container__J6TCg",
  "floatingMenu-module_popup__v8iVF": "taskForm-module_floatingMenu-module_popup__v8iVF__0GwNg",
  "_bobject_type_selector": "taskForm-module__bobject_type_selector__AQySf",
  "content_container": "taskForm-module_content_container__tZy-6",
  "bottom_bar": "taskForm-module_bottom_bar__ZvXQ1",
  "text": "taskForm-module_text__Cycie",
  "record_related": "taskForm-module_record_related__AgmET",
  "editor": "taskForm-module_editor__-CCtk",
  "wrapper": "taskForm-module_wrapper__bMPoD",
  "dragging": "taskForm-module_dragging__2OSEM",
  "divider": "taskForm-module_divider__lwQbZ",
  "bobject_selector": "taskForm-module_bobject_selector__xCm8D",
  "toolbar": "taskForm-module_toolbar__-G3Jo",
  "mainNote": "taskForm-module_mainNote__dxWA1",
  "modal_title": "taskForm-module_modal_title__-5rtw",
  "task_info": "taskForm-module_task_info__4Arj7",
  "task_date": "taskForm-module_task_date__ugxgf",
  "task_date_title": "taskForm-module_task_date_title__8k8Rn",
  "date_button": "taskForm-module_date_button__qAXzc",
  "textArea": "taskForm-module_textArea__u-KON",
  "textArea_extended": "taskForm-module_textArea_extended__18Imm",
  "add_task_button": "taskForm-module_add_task_button__J7ULi"
};
...
_s4(TaskForm, "bihFxbO2w8reNxYXdbfOkKKJroQ=", false, function () {
...
var useTaskForm = function useTaskForm(modalId) {
  ...
  var taskRelatedBobjectName = getTextFromLogicRole(taskRelatedBobject,
  // @ts-ignore
  ...
  var defaultRelated =
  // @ts-ignore
  (otherData !== null && otherData !== void 0 && otherData.related ?
  // @ts-ignore
  ...
  var defaultName =
  // @ts-ignore
  (otherData !== null && otherData !== void 0 && otherData.relatedName ?
  // @ts-ignore
...
_s5(useTaskForm, "6j6CObMLytGIqOHm82H/8bx4dQk=", false, function () {
  return [useReminders, useForm, useMinimizableModal, useActiveUserSettings, useCustomTasks, useUserHelpers, useAddToCalendar, useToasts, useTranslation, useVisible, useController, useController, useController, useController, useController, useConfirmDeleteModal];
});
var css_248z$1 = ".taskFeedErrorPage-module_wrapper__PbK7e {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 16px;\n  margin-top: 24px;\n  padding: 0 8px;\n}\n";
var styles$1 = {
  "wrapper": "taskFeedErrorPage-module_wrapper__PbK7e"
};
...
_s6(TaskFeedErrorPage, "t/1iBAGEdX8rDM6vi/jYf+ryVbo=", false, function () {
  return [useTranslation];
});
_c5 = TaskFeedErrorPage;
var css_248z = ".taskStaticModal-module_container__KGmLv {\n    padding: 18px 8px;\n    background-color: var(--white);\n}\n";
var styles = {
  "container": "taskStaticModal-module_container__KGmLv"
};
...
_s7(TaskStaticModal, "LgmVAx0EP0+R2brs7CDPZn8ihSI=", false, function () {
...
$RefreshReg$(_c2, "TaskTypeSelector");
$RefreshReg$(_c3, "TaskForm");
$RefreshReg$(_c4, "REMINDERS_KEY");
$RefreshReg$(_c5, "TaskFeedErrorPage");
$RefreshReg$(_c6, "TaskStaticModal");
if (import.meta.hot) {
