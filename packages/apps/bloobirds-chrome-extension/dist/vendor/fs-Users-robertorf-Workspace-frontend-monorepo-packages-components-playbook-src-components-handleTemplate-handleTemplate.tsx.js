...
if (import.meta.hot) {
  ...
  window.$RefreshReg$ = (type, id) => {
    RefreshRuntime.register(type, "/Users/robertorf/Workspace/frontend-monorepo/packages/components/playbook/src/components/handleTemplate/handleTemplate.tsx " + id);
  };
  window.$RefreshSig$ = RefreshRuntime.createSignatureFunctionForTransform;
}
var _jsxFileName = "/Users/robertorf/Workspace/frontend-monorepo/packages/components/playbook/src/components/handleTemplate/handleTemplate.tsx", _s = $RefreshSig$();
import __vite__cjsImport2_react from "/vendor/.vite-deps-react.js__v--2922b7f0.js"; const useCallback = __vite__cjsImport2_react["useCallback"]; const useEffect = __vite__cjsImport2_react["useEffect"]; const useMemo = __vite__cjsImport2_react["useMemo"]; const useState = __vite__cjsImport2_react["useState"];
...
import { useAttachedFiles } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-misc-dist-index.js.js";
...
import { focusEditor } from "/vendor/.vite-deps-@udecode_plate.js__v--feffb7cb.js";
...
import { HandleTemplateHeader } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-playbook-src-components-handleTemplate-components-handleTemplateHeader.tsx.js";
...
import { TemplateForm } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-playbook-src-components-handleTemplate-components-templateForm.tsx.js";
...
export const HandleTemplate = ({
  ...
  const onSubmit = async (data) => {
    const isNameEmpty = !data || !data.name || !data.name[0].children || data.name[0].children[0].text === "";
    if (isNameEmpty) {
      switchView();
      setError("name", {
        type: "required",
  ...
  function handleConfirm() {
    handleSubmit((data) => onSubmit(data), (err) => console.log(...oo_oo(`3372238133_134_13_134_38_4`, "error", err)))();
  }
  function handleSave() {
  ...
  function handleEvent(e) {
    if (e.key === "Tab") {
      updateFocusedIndex();
      e.stopPropagation();
      const focusedEditor = editorsRef.current[focusedRef.current];
  ...
  return /* @__PURE__ */ _jsxDEV("div", {
    ...
    children: [/* @__PURE__ */ _jsxDEV(FormProvider, {
      ...formMethods,
      children: [/* @__PURE__ */ _jsxDEV(HandleTemplateHeader, {
        onBack,
        handleSave,
        viewSegmentation,
        switchView,
        ...
        lineNumber: 180,
        columnNumber: 9
      }, void 0), viewSegmentation ? /* @__PURE__ */ _jsxDEV(SegmentationForm, {
        canBeBattlecard: isSnippet
      }, void 0, false, {
        fileName: _jsxFileName,
        lineNumber: 189,
        columnNumber: 11
      }, void 0) : /* @__PURE__ */ _jsxDEV(TemplateForm, {
        template,
        contextProps,
        ...attachedFilesFunctions
      }, void 0, false, {
...
_s(HandleTemplate, "gQEA4v6uFo3CGc+V2n2H4OSWATM=", false, function() {
