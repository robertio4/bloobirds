import { createHotContext as __vite__createHotContext } from "/vendor/vite-client.js";import.meta.hot = __vite__createHotContext("/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-dialer-src-dial.tsx.js");import RefreshRuntime from "/vendor/react-refresh.js";
let prevRefreshReg;
let prevRefreshSig;
if (import.meta.hot) {
  ...
  window.$RefreshReg$ = (type, id) => {
    RefreshRuntime.register(type, "/Users/robertorf/Workspace/frontend-monorepo/packages/components/dialer/src/dial.tsx " + id);
  };
  window.$RefreshSig$ = RefreshRuntime.createSignatureFunctionForTransform;
}
var _jsxFileName = "/Users/robertorf/Workspace/frontend-monorepo/packages/components/dialer/src/dial.tsx", _s = $RefreshSig$();
...
import { SearchBobjects } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-bobjects-dist-index.js.js";
import { Icon, IconButton, Spinner, Text, Tooltip } from "/vendor/.vite-deps-@bloobirds-it_flamingo-ui.js__v--2cc8757f.js";
import { useActiveUserSettings, useSuggestedTemplates } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-dist-index.js.js";
import { InfoWarning } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-misc-dist-index.js.js";
import { BobjectTypes, LEAD_FIELDS_LOGIC_ROLE, MIXPANEL_EVENTS, MessagesEvents, PlaybookTab } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-dist-index.js.js";
import { api, getTextFromLogicRole, isValidPhone as checkValidPhone } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js";
...
import { AsYouType } from "/vendor/.vite-deps-libphonenumber-js.js__v--da3005b6.js";
import __vite__cjsImport12_lodash_debounce from "/vendor/.vite-deps-lodash_debounce.js__v--ce8d7378.js"; const debounce = __vite__cjsImport12_lodash_debounce.__esModule ? __vite__cjsImport12_lodash_debounce.default : __vite__cjsImport12_lodash_debounce;
...
import bobjectStyles from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-dialer-src-bobjectItem.module.css.js";
import { DialerOpenStatus, DialerStatus, DialerTab, useDialer, useDialerStore } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-dialer-src-dialer.tsx.js";
...
async function tryToMatchPhoneNumber(dialedPhoneNumber, bobjectId, setMatchedBobject) {
  ...
  try {
    ...
    if (response.status === 200) {
      ...
      if (bobject) {
        ...
        const name = getTextFromLogicRole(bobject, type.toUpperCase() + (isLead ? "__FULL_NAME" : "__NAME"));
        const leadCompanyId = isLead && getTextFromLogicRole(bobject, LEAD_FIELDS_LOGIC_ROLE.COMPANY);
        const foundBobject = {
          bobject,
    ...
    console.log(...oo_oo(`1967090542_113_4_113_18_4`, e));
    setMatchedBobject({
      hasMatched: false
    });
  }
...
export const Dial = () => {
  ...
  const [bobjectsWithSamePhone, setBobjectsWithSamePhone] = useState([]);
  ...
  useSuggestedTemplates(bobjectOfPhone?.bobject, void 0, PlaybookTab.PITCHES);
  const {
    t
  } = useTranslation();
  const {
  ...
  const shouldRenderLoader = bobjectOfPhone && bobjectOfPhone.hasMatched === void 0 && dialedPhoneNumber?.startsWith("+") && dialedPhoneNumber?.length >= 9;
  const isNumber = search && search.length > 0 && (search.startsWith("+") && search.length >= 9 || isValidPhone(search)) || isNumeric(search);
  ...
  return /* @__PURE__ */ _jsxDEV("div", {
    ...
    children: [/* @__PURE__ */ _jsxDEV(SearchBobjects, {
      ...
      anchorElement: () => /* @__PURE__ */ _jsxDEV("input", {
      ...
      children: (results, totalMatching) => {
        const noData = results?.length === 0 || results?.filter((item) => item.phone || item.phoneNumbers?.length > 0).length === 0;
        setNoResults(noData);
        ...
        return /* @__PURE__ */ _jsxDEV("div", {
          ...
          children: phoneNumbersWithData.length > 0 ? /* @__PURE__ */ _jsxDEV(VirtualInfiniteScroll, {
            parentRef,
            ...
            lineNumber: 324,
            columnNumber: 17
          }, void 0) : !isNumber && /* @__PURE__ */ _jsxDEV("div", {
      ...
      children: [!search && !dialedPhoneNumber && (status !== DialerStatus.authorizing ? /* @__PURE__ */ _jsxDEV("div", {
        className: styles.dialHelpText,
        children: /* @__PURE__ */ _jsxDEV(Text, {
          size: "xs",
          color: "softPeanut",
          weight: "bold",
        ...
        className: styles.dialHelpTextNotConfig,
        children: /* @__PURE__ */ _jsxDEV(Text, {
          size: "xs",
          color: "softPeanut",
          weight: "bold",
        ...
        lineNumber: 411,
        columnNumber: 13
      }, void 0)), shouldRenderLoader ? /* @__PURE__ */ _jsxDEV("div", {
        className: styles.dialSpinner,
        ...
        lineNumber: 418,
        columnNumber: 11
      }, void 0) : bobjectOfPhone && (bobjectOfPhone.hasMatched ? /* @__PURE__ */ _jsxDEV("div", {
        className: styles.dialMatchText,
        children: bobjectsWithSamePhone?.length > 1 ? /* @__PURE__ */ _jsxDEV(_Fragment, {
          children: [/* @__PURE__ */ _jsxDEV("div", {
        ...
        lineNumber: 424,
        columnNumber: 13
      }, void 0) : search && /* @__PURE__ */ _jsxDEV("div", {
        className: styles.dialMatchText,
        children: [/* @__PURE__ */ _jsxDEV(Icon, {
          name: "phone",
          size: 16,
...
_s(Dial, "yEAf7VnKKl6dKNE143YPqL4VIdU=", false, function() {
  return [useDialerStore, useDialer, useDialer, useDialer, useDialer, useDialer, useDialer, useSuggestedTemplates, useTranslation, useActiveUserSettings];
});
_c = Dial;
;
function oo_cm() {
