import {
  require_md5
} from "/vendor/.vite-deps-chunk-HCUIKFBX.js__v--e5be5ac4.js";
import {
  __commonJS
} from "/vendor/.vite-deps-chunk-S5KM4IGW.js__v--e5be5ac4.js";

// ../../../node_modules/@twilio/voice-sdk/node_modules/events/events.js
var require_events = __commonJS({
  "../../../node_modules/@twilio/voice-sdk/node_modules/events/events.js"(exports, module) {
    "use strict";
...
var require_log = __commonJS({
  "../../../node_modules/@twilio/voice-sdk/es5/twilio/log.js"(exports) {
    ...
    var Log = function() {
      ...
      Log2.getInstance = function() {
        if (!Log2.instance) {
          Log2.instance = new Log2();
        }
      ...
      Log2.prototype.getLogLevelInstance = function() {
        return this._log;
      };
...
var require_audiohelper = __commonJS({
  "../../../node_modules/@twilio/voice-sdk/es5/twilio/audiohelper.js"(exports) {
    ...
    var AudioHelper = function(_super) {
      ...
      function AudioHelper2(onActiveOutputsChanged, onActiveInputChanged, getUserMedia, options) {
        var _a;
        var _this = _super.call(this) || this;
      ...
      AudioHelper2.prototype._getEnabledSounds = function() {
        ...
        _this._onAnswerOrRinging = function(payload) {
          ...
          if (_this.status !== "closed") {
            _this.version.processAnswer(_this.codecPreferences, sdp, null, function(err) {
              ...
              _this._log.info("Failed to process answer during ICE Restart. Error: " + message2);
            });
          }
        };
    ...
    var Device = function(_super) {
      ...
      function Device2(token, options) {
        ...
        _this._onGetUserMedia = function() {
          var _a2;
          (_a2 = _this._audio) === null || _a2 === void 0 ? void 0 : _a2._updateAvailableDevices().catch(function(error) {
          ...
          return __generator(this, function(_b) {
            switch (_b.label) {
              case 0:
                ...
                _a = this;
                return [4, this._makeCall(options.params || {}, {
                  enableImprovedSignalingErrorPrecision: !!this._options.enableImprovedSignalingErrorPrecision,
            ...
            switch (_a.label) {
              ...
              case 1:
                ...
                streamReadyPromise = new Promise(function(resolve) {
                  _this.once(Device2.State.Registered, resolve);
                });
      ...
      Device2.prototype._makeCall = function(twimlParams, options) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            switch (_b.label) {
              ...
              case 1:
                ...
                call.once("accept", function() {
                  ...
                  if (call.direction === call_1.default.CallDirection.Outgoing && ((_a2 = _this._audio) === null || _a2 === void 0 ? void 0 : _a2.outgoing())) {
  ...
  "../../../node_modules/@twilio/voice-sdk/es5/twilio/call.js"(exports) {
    ...
    var Call = function(_super) {
      ...
      function Call2(config, options) {
        ...
        _this._direction = _this.parameters.CallSid ? Call2.CallDirection.Incoming : Call2.CallDirection.Outgoing;
        if (_this._direction === Call2.CallDirection.Incoming && _this.parameters) {
    ...
    (function(Call2) {
      ...
      (function(MessageType2) {
        MessageType2["UserDefinedMessage"] = "user-defined-message";
      })(MessageType = Call2.MessageType || (Call2.MessageType = {}));
    })(Call || (Call = {}));
