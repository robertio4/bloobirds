import {
  Button
} from "/vendor/.vite-deps-chunk-TQOAS2VJ.js__v--d28ff40c.js";
import {
  Ce,
  PortalBody,
  createStyles,
  styled_components_browser_esm_default
} from "/vendor/.vite-deps-chunk-22IKQRCZ.js__v--d28ff40c.js";
import {
  flip,
  ...
  useFloating,
  useVirtualFloating
} from "/vendor/.vite-deps-chunk-QW53TVAD.js__v--d28ff40c.js";
import {
  findNodePath,
  focusEditor,
  getSelectionText,
  ...
  useEventPlateId,
  usePlateEditorState
} from "/vendor/.vite-deps-chunk-HGZEDJTY.js__v--d28ff40c.js";
import {
  useFocused
} from "/vendor/.vite-deps-chunk-73EC23W7.js__v--d28ff40c.js";
import {
  applyStyles_default,
  createPopper3 as createPopper
} from "/vendor/.vite-deps-chunk-7CDCIN3W.js__v--d28ff40c.js";
import {
  require_react_dom
} from "/vendor/.vite-deps-chunk-3UKJDGBQ.js__v--d28ff40c.js";
import {
  require_react
...
var primaryButtonCss = [plateButtonCss, {
  "--tw-bg-opacity": "1",
...
var PlateButton = ({
  ...
  css: _css,
  ...props
}) => import_react.default.createElement(_StyledButton, props);
...
var Icon = (0, import_react.forwardRef)((props, ref) => {
  ...
  return import_react.default.createElement("svg", _extends({}, iconProps, {
    ref
  }), title && import_react.default.createElement("title", {
    key: "icon-title"
  }, title), children);
});
var StyledIcon = styled_components_browser_esm_default(Icon).withConfig({
  displayName: "StyledIcon",
  componentId: "sc-1lmwuuu-0"
})(["display:inline-block;vertical-align:", ";overflow:hidden;height:100%;"], (props) => props.iconVerticalAlign);
var DeleteIcon = (props) => import_react.default.createElement(StyledIcon, _extends({
  viewBox: "0 0 24 24",
  fill: "currentColor"
...
var RemoveNodeButton = ({
  ...
  return import_react.default.createElement(_StyledPlateButton, _extends({
    onClick: () => {
    ...
    $_css: [{
      ...
      "paddingRight": "0px"
        ...
        height: 24px;
      `]
  }), import_react.default.createElement(DeleteIcon, null));
};
...
var ChevronDownIcon = (props) => import_react.default.createElement(_StyledStyledIcon, _extends({
  viewBox: "0 0 24 24",
  focusable: "false",
  "aria-hidden": "true"
}, props), import_react.default.createElement("path", {
...
var _StyledStyledIcon = styled_components_browser_esm_default(StyledIcon).withConfig({
...
function TippyGenerator(tippy2) {
  function Tippy(_ref) {
    ...
    return import_react2.default.createElement(import_react2.default.Fragment, null, children ? (0, import_react2.cloneElement)(children, {
...
var forwardRef2 = function(Tippy, defaultProps2) {
  return (0, import_react2.forwardRef)(function TippyWrapper(_ref, _ref2) {
    var children = _ref.children, props = _objectWithoutPropertiesLoose(_ref, ["children"]);
    return import_react2.default.createElement(Tippy, Object.assign({}, defaultProps2, props), children ? (0, import_react2.cloneElement)(children, {
      ref: function ref(node) {
...
var index = forwardRef2(TippyGenerator(tippy_esm_default));
var tippy_react_esm_default = index;

// ../../../node_modules/@udecode/plate-ui-toolbar/dist/index.es.js
var FloatingVerticalDivider = () => import_react3.default.createElement(_StyledDiv$1, null);
...
var floatingRootCss = Ce(["", ";border-radius:4px;box-shadow:rgb(15 15 15 / 5%) 0 0 0 1px,rgb(15 15 15 / 10%) 0 3px 6px,rgb(15 15 15 / 20%) 0 9px 24px;"], {
  "--tw-bg-opacity": "1",
  "backgroundColor": "rgba(255, 255, 255, var(--tw-bg-opacity))",
  "zIndex": "20 !important",
  "width": "auto"
});
var floatingRowCss = Ce(["", ";"], {
  "paddingLeft": "0.5rem",
  "paddingRight": "0.5rem",
  "paddingTop": "0.25rem",
  "paddingBottom": "0.25rem",
...
var FloatingIconWrapper = styled_components_browser_esm_default.div.withConfig({
...
var FloatingInputWrapper = styled_components_browser_esm_default.div.withConfig({
...
var getBalloonToolbarStyles = (props) => {
  ...
  const arrowStyle = [props.arrow && Ce(["::after{left:50%;content:' ';position:absolute;margin-top:-1px;transform:translateX(-50%);border-color:", " transparent;border-style:solid;}"], background), props.arrow && placement.includes("top") && Ce(["::after{top:100%;bottom:auto;border-width:8px 8px 0;}"]), props.arrow && !placement.includes("top") && Ce(["::after{top:auto;bottom:100%;border-width:0 8px 8px;}"])];
  const arrowBorderStyle = [props.arrow && placement.includes("top") && props.theme === "light" && Ce(["::before{margin-top:0;border-width:9px 9px 0;border-color:", " transparent;}"], borderColor), props.arrow && !placement.includes("top") && props.theme === "light" && Ce(["::before{margin-top:0;border-width:0 9px 9px;border-color:", " transparent;}"], borderColor)];
  return createStyles({
    ...
    }, Ce(["color:", ";background:", ";z-index:500;border:1px solid ", ";border-radius:4px;.slate-ToolbarButton-active,.slate-ToolbarButton:hover{color:", ";}::before{", "}"], color, background, borderColor, colorActive, arrowBorderStyle), ...arrowStyle, ...arrowBorderStyle]
  });
};
function _extends2() {
...
var ToolbarBase = import_react3.default.forwardRef((props, ref) => {
  return import_react3.default.createElement("div", _extends2({
    "data-testid": "Toolbar",
    ref
  }, props));
});
var _StyledToolbarBase$2 = styled_components_browser_esm_default(ToolbarBase).withConfig({
  displayName: "Toolbar___StyledToolbarBase",
  componentId: "sc-1srlh8g-0"
})(["", ""], (p) => p.$_css);
var Toolbar = import_react3.default.forwardRef((props, ref) => {
  const {
    root
  } = getToolbarStyles(props);
  return import_react3.default.createElement(_StyledToolbarBase$2, _extends2({}, props, {
    ref,
...
var useFloatingToolbar = ({
  ...
  const [waitForCollapsedSelection, setWaitForCollapsedSelection] = (0, import_react3.useState)(false);
...
var BalloonToolbar = (props) => {
  ...
  }, import_react3.default.createElement(_StyledToolbarBase$1, {
...
var _StyledToolbarBase$1 = styled_components_browser_esm_default(ToolbarBase).withConfig({
  displayName: "BalloonToolbar___StyledToolbarBase",
  componentId: "sc-s0c2tw-0"
})(["", ""], (p) => p.$_css);
var getToolbarButtonStyles = (props) => {
  var _props$styles;
  return createStyles({
...
var ToolbarButton = (props) => {
  ...
  const button = import_react3.default.createElement(_StyledButton2, _extends2({
  ...
  return tooltip ? import_react3.default.createElement(tippy_react_esm_default, tooltipProps, button) : button;
};
...
var BlockToolbarButton = ({
  ...
  return import_react3.default.createElement(ToolbarButton, _extends2({
    active,
    onClick: (e) => {
      e.preventDefault();
      e.stopPropagation();
...
var getHeadingToolbarStyles = (props) => createStyles({
  ...
  root: [...getToolbarStyles(props).root.css, {
    ...
    "marginLeft": "-1.25rem",
    "marginRight": "-1.25rem"
  }, Ce(["padding:1px 18px 17px;border-bottom:2px solid #eee;.slate-ToolbarButton-active,.slate-ToolbarButton:hover{color:#06c;}"])]
}]);
var HeadingToolbar = import_react3.default.forwardRef((props, ref) => {
  const styles = getHeadingToolbarStyles(props);
  return import_react3.default.createElement(_StyledToolbarBase, _extends2({
    ref,
    className: styles.root.className
  }, props, {
    $_css: styles.root.css
...
var _StyledToolbarBase = styled_components_browser_esm_default(ToolbarBase).withConfig({
  displayName: "HeadingToolbar___StyledToolbarBase",
  componentId: "sc-1gnw7ox-0"
})(["", ""], (p) => p.$_css);
var MarkToolbarButton = ({
  id,
  type,
  clear,
  ...props
...
var closeAllExceptSelectedOneListener = ({
  open,
  onClose,
  refs
}) => (ev) => {
...
var ToolbarDropdown = ({
  ...
  return import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("div", {
    ref: reference,
    onMouseDown: onOpen
  }, control), open && import_react3.default.createElement(_StyledDiv, {
    ref: floating,
    style: styles
  }, children));
};
...
//# sourceMappingURL=chunk-ABCUCCG5.js.map
