...
if (import.meta.hot) {
  ...
  window.$RefreshReg$ = (type, id) => {
    RefreshRuntime.register(type, "/Users/robertorf/Workspace/frontend-monorepo/packages/components/playbook/src/components/handleTemplateModal/components/templateModalForm.tsx " + id);
  };
  window.$RefreshSig$ = RefreshRuntime.createSignatureFunctionForTransform;
}
var _jsxFileName = "/Users/robertorf/Workspace/frontend-monorepo/packages/components/playbook/src/components/handleTemplateModal/components/templateModalForm.tsx", _s = $RefreshSig$();
import __vite__cjsImport2_react from "/vendor/.vite-deps-react.js__v--2922b7f0.js"; const useCallback = __vite__cjsImport2_react["useCallback"]; const useEffect = __vite__cjsImport2_react["useEffect"]; const useRef = __vite__cjsImport2_react["useRef"]; const useState = __vite__cjsImport2_react["useState"];
import { useController, useFormContext } from "/vendor/.vite-deps-react-hook-form.js__v--457cf28b.js";
import { useTranslation } from "/vendor/.vite-deps-react-i18next.js__v--8418bf92.js";
import { deserialize, EditorToolbar, EditorToolbarControlsSection, EditorToolbarFileAttachment, EditorToolbarFontStylesSection, EditorToolbarImage, EditorToolbarListsSection, TemplateEditorToolbarMeetingLink, EditorToolbarSection, EditorToolbarTemplateVariable, EditorToolbarTextMarksSection, RichTextEditor, useRichTextEditorPlugins } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-richTextEditor-dist-index.js.js";
import { TEMPLATE_TYPES } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-dist-index.js.js";
import { isHtml, stringToHTML, createParagraph } from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js";
import { focusEditor, insertElements, resetEditorChildren } from "/vendor/.vite-deps-@udecode_plate.js__v--feffb7cb.js";
...
import styles from "/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-playbook-src-components-handleTemplateModal-components-templateModalForm.module.css.js";
  ...
  if (editor) {
    ...
    if (value) {
      try {
        ...
        console.log(...oo_oo(`1222714924_37_8_37_47_4`, "\u274C Error parsing value", e));
        if (isHtml(value)) {
          const parsedNodes = deserialize(stringToHTML(value), {
            format: "HTML",
            plugins
          });
          value = parsedNodes.map((node) => ({
            type: "p",
            children: [node]
          }));
        } else {
...
export function TemplateModalForm({
  ...
  const showVariables = [TEMPLATE_TYPES.EMAIL, TEMPLATE_TYPES.LINKEDIN, TEMPLATE_TYPES.WHATSAPP].includes(template.type);
  const {
    formState: {
      isDirty
    }
  ...
  const [haveEditorsBeenStored, setHaveEditorsBeenStored] = useState(false);
  ...
  function storeEditorRef(editor) {
    if (haveEditorsBeenStored || editorsRef?.current?.some((storedEditor) => storedEditor?.id === editor.id))
      return;
  ...
  useEffect(() => {
    if (editorsRef?.current?.length === ([TEMPLATE_TYPES.EMAIL, TEMPLATE_TYPES.SNIPPET].includes(template.type) ? 3 : 2)) {
  ...
  function handleEvent(e) {
    if (e.key === "Tab") {
      updateFocusedIndex();
      e.stopPropagation();
      const focusedEditor = editorsRef.current[focusedEditorRef.current];
      if (focusedEditor?.id === "shortcutInput") {
  ...
  return /* @__PURE__ */ _jsxDEV(TemplateFormContext.Provider, {
    ...
    children: [/* @__PURE__ */ _jsxDEV("div", {
      ...
      children: [/* @__PURE__ */ _jsxDEV(NameFormEditor, {
        isTemplateModal: true
      }, void 0, false, {
        fileName: _jsxFileName,
        lineNumber: 187,
        columnNumber: 9
      }, this), /* @__PURE__ */ _jsxDEV(TemplateFormFieldsByType, {
        isTemplateModal: true
      }, void 0, false, {
        fileName: _jsxFileName,
        lineNumber: 188,
        ...
        children: (editor) => /* @__PURE__ */ _jsxDEV(_Fragment, {
          children: [/* @__PURE__ */ _jsxDEV("div", {
            ...
            children: /* @__PURE__ */ _jsxDEV(EditorToolbar, {
              ...
              children: [/* @__PURE__ */ _jsxDEV(EditorToolbarControlsSection, {}, void 0, false, {
                fileName: _jsxFileName,
                lineNumber: 211,
                columnNumber: 19
              }, this), /* @__PURE__ */ _jsxDEV(EditorToolbarFontStylesSection, {
                enableChangeSize: true
              }, void 0, false, {
                fileName: _jsxFileName,
                lineNumber: 212,
                columnNumber: 19
              }, this), /* @__PURE__ */ _jsxDEV(EditorToolbarTextMarksSection, {
                color: "white",
                ...
                lineNumber: 213,
                columnNumber: 19
              }, this), /* @__PURE__ */ _jsxDEV(EditorToolbarListsSection, {}, void 0, false, {
                fileName: _jsxFileName,
                lineNumber: 214,
                columnNumber: 19
              }, this), showAttachmentSection && /* @__PURE__ */ _jsxDEV(EditorToolbarSection, {
                children: [showMeetingLinksAndAttachments && /* @__PURE__ */ _jsxDEV(_Fragment, {
                  children: [/* @__PURE__ */ _jsxDEV(TemplateEditorToolbarMeetingLink, {}, void 0, false, {
                    fileName: _jsxFileName,
                    lineNumber: 219,
                    columnNumber: 27
                  }, this), /* @__PURE__ */ _jsxDEV(EditorToolbarFileAttachment, {
                ...
                }, void 0, true), showImages && /* @__PURE__ */ _jsxDEV(EditorToolbarImage, {}, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 223,
                  columnNumber: 38
                }, this), showVariables && /* @__PURE__ */ _jsxDEV(EditorToolbarTemplateVariable, {}, void 0, false, {
                  fileName: _jsxFileName,
                  lineNumber: 224,
                  columnNumber: 41
                }, this)]
...
oo_te;
var _c;
$RefreshReg$(_c, "TemplateModalForm");
if (import.meta.hot) {
