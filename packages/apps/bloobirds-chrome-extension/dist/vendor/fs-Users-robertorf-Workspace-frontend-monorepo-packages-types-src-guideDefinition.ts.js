...
export const getQuickStartGuideBlocks = (hasCadencePermission, cadencesV2Enabled, params) => [
  {
  ...
  },
  {
    ...
    goals: [
      ...
      },
      {
        ...
        linkNavigation: params?.LINKEDIN_SALES?.hasExtension ? "https://www.linkedin.com/in/tonipereznavarro/" : "https://chrome.google.com/webstore/detail/bloobirds/bfnmjliageccndnbpoadbigbnhicogbh"
      },
      {
        ...
        linkNavigation: params?.LINKEDIN_SALES?.hasExtension ? `${APP_TASKS_INBOX}/linkedin` : "https://chrome.google.com/webstore/detail/bloobirds/bfnmjliageccndnbpoadbigbnhicogbh"
      }
    ]
  },
  {
