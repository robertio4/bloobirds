...
import { useVisible, Dropdown, SearchInput, Item, Tooltip, CircularBadge, Text, Icon, useToasts, Modal, ModalHeader, ModalTitle, ModalCloseIcon, Callout, Checkbox, ModalFooter, Button } from '/vendor/.vite-deps-@bloobirds-it_flamingo-ui.js__v--2cc8757f.js';
import { useDebounce } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-dist-index.js.js';
import { LEAD_FIELDS_LOGIC_ROLE, COMPANY_FIELDS_LOGIC_ROLE } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-dist-index.js.js';
import { api, injectReferencesSearchProcess, getFieldByLogicRole, getValueFromLogicRole } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js';
