...
import { useConfirmDeleteModal, FormField } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-components-bobjects-dist-index.js.js';
import { Modal, ModalHeader, Icon, IconButton, ModalFooter, Button, Select, Item } from '/vendor/.vite-deps-@bloobirds-it_flamingo-ui.js__v--2cc8757f.js';
import { useDataModel, useQuickLogActivity } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-hooks-dist-index.js.js';
import { ACTIVITY_FIELDS_LOGIC_ROLE, BobjectTypes, MIXPANEL_EVENTS, LEAD_FIELDS_LOGIC_ROLE } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-types-dist-index.js.js';
import { getFieldByLogicRole, getTextFromLogicRole, removeScrollOfBox, recoverScrollOfBox } from '/vendor/fs-Users-robertorf-Workspace-frontend-monorepo-packages-utils-dist-index.js.js';
