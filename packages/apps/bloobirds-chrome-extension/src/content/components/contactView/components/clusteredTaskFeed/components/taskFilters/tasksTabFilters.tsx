...
import { ActivityFeedUserFilter } from '@bloobirds-it/activity-feed';
import {
  CheckItem,
  Icon,
  MultiSelect,
      ...
      <div className={styles.filters}>
        ...
        {sort?.type === 'BY_BLOOBIRDS_CLUSTERING' && (
          ...
          >
            ...
            <Chip value="completedTasks">
              <Icon name="checkDouble" size={14} color="darkBloobirds" />
              <span>{t('taskFeed.completedTasks')}</span>
            </Chip>
          </CustomChipGroup>
        )}
      </div>
