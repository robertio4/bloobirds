...
import * as rawJson from '../constants/timezonesByCountry.json';
...
export const privateTimeZoneFunctions = () => {
  ...
  const getFirstAndLastSpaceTime = (timezones: string[]): number[] => {
 ...
 */
export const getCurrentTime = (countryOrTimeZone: string): number[] => {
