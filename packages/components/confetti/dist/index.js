import 'react';
import Confetti$1 from 'react-confetti';
...
var Confetti = (function () {
  ...
  var _useConfetti = useConfetti(),
    show = _useConfetti.show,
    hideConfetti = _useConfetti.hideConfetti;
  return show.display && /*#__PURE__*/jsx(Confetti$1, {
    width: width,
    height: height,
    style: {
      zIndex: 200
    ...
    drawShape: show.bloobirdsShape ? function (ctx) {
      ctx.beginPath();
