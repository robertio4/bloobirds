import React, { useState, useRef, useCallback, useEffect, useMemo, Fragment as Fragment$1, createContext, useContext } from 'react';
import { useTranslation, Trans } from 'react-i18next';
import { useVisible, Dropdown, Icon, Text, Select, Item, Checkbox, Button, IconButton, Radio, Input, Modal, ModalHeader, ModalTitle, ModalCloseIcon, ModalContent, ModalFooter, CompoundIcon, Avatar, Label, Tooltip } from '@bloobirds-it/flamingo-ui';
import { useCalendar, useDataModel, useFullSalesEnabled, useUserSearch, useActiveUserSettings, useTimeZones } from '@bloobirds-it/hooks';
import clsx from 'clsx';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { ACTIVITY_FIELDS_LOGIC_ROLE, MIXPANEL_EVENTS, COMPANY_FIELDS_LOGIC_ROLE, LEAD_FIELDS_LOGIC_ROLE } from '@bloobirds-it/types';
import { fetchAndOpenNylasUrl, getUserTimeZone, toTitleCase, getTimeFromOffset, getDurationFromOffset, isToday, getValueFromLogicRole } from '@bloobirds-it/utils';
import { DayCalendarBackground, Calendar as Calendar$1, Outlook } from '@bloobirds-it/assets';
...
var styles$4 = {"_calendars_container":"calendarSelector-module__calendars_container__3-gAH","_select_disabled":"calendarSelector-module__select_disabled__u81jA","_calendars_list":"calendarSelector-module__calendars_list__8m2zN","_help_container":"calendarSelector-module__help_container__gyHta","_help_text":"calendarSelector-module__help_text__SpYd2","_accounts_selector":"calendarSelector-module__accounts_selector__8HuNV","_select_anchor":"calendarSelector-module__select_anchor__5svZ5","_icon_container":"calendarSelector-module__icon_container__IOxcL","_select_text":"calendarSelector-module__select_text__cARFw"};
...
var styles$3 = {"_button":"brandedButtons-module__button__gSpAm","_icon":"brandedButtons-module__icon__hwq6Z","_text":"brandedButtons-module__text__MUtJP","_google__button":"brandedButtons-module__google__button__4-gMT brandedButtons-module__button__gSpAm","_ms__button":"brandedButtons-module__ms__button__eOOfE brandedButtons-module__button__gSpAm"};
...
var styles$2 = {"calendar_not_connected":"calendarNotConnected-module_calendar_not_connected__PrcRA","calendar_buttons":"calendarNotConnected-module_calendar_buttons__-bSYC","link":"calendarNotConnected-module_link__mRffk","day_calendar_not_connected_container":"calendarNotConnected-module_day_calendar_not_connected_container__Xvu81","day_calendar_not_connected":"calendarNotConnected-module_day_calendar_not_connected__I3L8i","_background_image":"calendarNotConnected-module__background_image__AFuAt","day_calendar_buttons":"calendarNotConnected-module_day_calendar_buttons__1yHhm","day_calendar_not_connected_overlay":"calendarNotConnected-module_day_calendar_not_connected_overlay__N6Fx1"};
...
var CalendarEvent = /*#__PURE__*/React.memo(function (_ref5) {
  var _spacetime;
...
var styles = {"slotsForm":"slotsForm-module_slotsForm__fjWoD","slotsFormHeader":"slotsForm-module_slotsFormHeader__7V0Td","slotsFormBody":"slotsForm-module_slotsFormBody__g0tbv","slotsFormBodyHidden":"slotsForm-module_slotsFormBodyHidden__2zO8A","formTitle":"slotsForm-module_formTitle__28WBG","arrowButton":"slotsForm-module_arrowButton__uM3Ow","sectionHeader":"slotsForm-module_sectionHeader__0VJri","timeSelector":"slotsForm-module_timeSelector__QNrF4","timeSlotForm":"slotsForm-module_timeSlotForm__25PcY","timeSlotFormHidden":"slotsForm-module_timeSlotFormHidden__B-NQq","slotsFormFooter":"slotsForm-module_slotsFormFooter__-rL3l","footerRight":"slotsForm-module_footerRight__Xxb61","modalContent":"slotsForm-module_modalContent__Js-J6","parsedSlots":"slotsForm-module_parsedSlots__tArV0"};
