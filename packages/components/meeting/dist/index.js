...
import { Tooltip, IconButton, Text, Input, DateTimePicker, MultiSelect, CheckItem, Select, Item, TextArea, useVisible, Dropdown, Icon, Checkbox, Button, CompoundIcon, Avatar, Label, Section, ChipGroup, Chip, SearchInput, Spinner, useToasts, Modal, ModalFooter, DatePicker } from '@bloobirds-it/flamingo-ui';
import clsx from 'clsx';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import { useFormContext, useController, useForm, FormProvider } from 'react-hook-form';
import { AutoCompleteSearchCompanies, useConfirmDeleteModal } from '@bloobirds-it/bobjects';
...
import { useRichTextEditorPlugins, RichTextEditor, EditorToolbar, EditorToolbarFontStylesSection, EditorToolbarTextMarksSection, EditorToolbarListsSection, deserialize, serialize } from '@bloobirds-it/rich-text-editor';
import { ACTIVITY_FIELDS_LOGIC_ROLE, LEAD_FIELDS_LOGIC_ROLE, ACTIVITY_TYPES, BobjectTypes, TEMPLATE_TYPES, MEETING_MAIN_TYPE_VALUES, UserHelperKeys, ACTIVITY_TYPES_VALUES_LOGIC_ROLE, LEAD_STAGE_LOGIC_ROLE, COMPANY_FIELDS_LOGIC_ROLE, COMPANY_STAGE_LOGIC_ROLE, MIXPANEL_EVENTS } from '@bloobirds-it/types';
import { getUserTimeZone, getValueFromLogicRole, getReferencedBobjectFromLogicRole, api, keepPreviousResponse, injectReferencesSearchProcess, getFieldById, fetchAndOpenNylasUrl, isToday, toTitleCase, removeHtmlTags, isHtml, createParagraph, isEmail, removeScrollOfBox, recoverScrollOfBox, getFieldByLogicRole } from '@bloobirds-it/utils';
...
import { DayCalendarBackground, Calendar as Calendar$1, Outlook, GoogleMeetWhiteSvg, GoogleMeetSvg } from '@bloobirds-it/assets';
...
var styles$b = {"_container":"infoCardTemplate-module__container__o-i9E","_container_distinction":"infoCardTemplate-module__container_distinction__EWNwa","_container_sales":"infoCardTemplate-module__container_sales__-a0Q4","_container_prospect":"infoCardTemplate-module__container_prospect__nM7Yo","_lead_container":"infoCardTemplate-module__lead_container__pmWYe","_info__container":"infoCardTemplate-module__info__container__dDQld","_mr_rating__container":"infoCardTemplate-module__mr_rating__container__wV-jb","_circular_badge__container":"infoCardTemplate-module__circular_badge__container__WKgY8","_lead_dropdown_element":"infoCardTemplate-module__lead_dropdown_element__DD0GO","_circular_badge__badge":"infoCardTemplate-module__circular_badge__badge__8TTUG","_opt_out_sign":"infoCardTemplate-module__opt_out_sign__-LpCW","_name_wrapper":"infoCardTemplate-module__name_wrapper__i3Jdj","_name__container":"infoCardTemplate-module__name__container__VwHz5","_name_text__container":"infoCardTemplate-module__name_text__container__xYZzT","_edit_icon":"infoCardTemplate-module__edit_icon__SJnw2","_edit_icon__visible":"infoCardTemplate-module__edit_icon__visible__zHeZs","_status__container":"infoCardTemplate-module__status__container__p9oGB","_status__container__clickable":"infoCardTemplate-module__status__container__clickable__W-7pj","_assignTo__container":"infoCardTemplate-module__assignTo__container__KNvpL","_fields__container":"infoCardTemplate-module__fields__container__qeptG","_field__container":"infoCardTemplate-module__field__container__eP372","_link_field_container":"infoCardTemplate-module__link_field_container__vl1qO","_field_link":"infoCardTemplate-module__field_link__obw3F","_warning__dot":"infoCardTemplate-module__warning__dot__-icYA","_inactive__container":"infoCardTemplate-module__inactive__container__PoAFW","_inactive__container_pointer":"infoCardTemplate-module__inactive__container_pointer__XId-E","_circular_badge__button":"infoCardTemplate-module__circular_badge__button__-qXxG","_circular_badge__button_hovered":"infoCardTemplate-module__circular_badge__button_hovered__Qrv1O","_tag__container":"infoCardTemplate-module__tag__container__k-o2s","_tag__content":"infoCardTemplate-module__tag__content__MPdrR","_contextual__menu":"infoCardTemplate-module__contextual__menu__b0mkh","link":"infoCardTemplate-module_link__kq3EA","_copy_component":"infoCardTemplate-module__copy_component__Wg3I3","_link_copy_component":"infoCardTemplate-module__link_copy_component__7DyEk","_copy_icon":"infoCardTemplate-module__copy_icon__Abudr","_show_icon":"infoCardTemplate-module__show_icon__zPbuG"};
...
function _slicedToArray$e(arr, i) { return _arrayWithHoles$e(arr) || _iterableToArrayLimit$e(arr, i) || _unsupportedIterableToArray$h(arr, i) || _nonIterableRest$e(); }
...
function _toConsumableArray$6(arr) { return _arrayWithoutHoles$6(arr) || _iterableToArray$6(arr) || _unsupportedIterableToArray$g(arr) || _nonIterableSpread$6(); }
...
function _arrayWithoutHoles$6(arr) { if (Array.isArray(arr)) return _arrayLikeToArray$g(arr); }
...
var styles$a = {"modal__container":"meetingModal-module_modal__container__Ewdmu","titleInput":"meetingModal-module_titleInput__i0fZl","_header__container":"meetingModal-module__header__container__jTDFT","_form_column":"meetingModal-module__form_column__hixZ7","_header__info":"meetingModal-module__header__info__EV6js","_header_right_actions":"meetingModal-module__header_right_actions__W1NBf","_header__date_picker":"meetingModal-module__header__date_picker__Pd7Zm","_header__spacer":"meetingModal-module__header__spacer__MrheH","_date_picker":"meetingModal-module__date_picker__FXT74","_calendar":"meetingModal-module__calendar__sypTU","_body":"meetingModal-module__body__CxpgE","footer":"meetingModal-module_footer__R69Xk","_main_row":"meetingModal-module__main_row__6EfOs","_event_info":"meetingModal-module__event_info__1RZPA","_row_header":"meetingModal-module__row_header__-4EDd","_event_row_header":"meetingModal-module__event_row_header__zu9gD","_calendar_select":"meetingModal-module__calendar_select__BI6w9","_note_container":"meetingModal-module__note_container__utiC7","_note_row":"meetingModal-module__note_row__-SfBN","_event_type_selector":"meetingModal-module__event_type_selector__KrWXv","_event_type":"meetingModal-module__event_type__A-K67","_additionalFields_content":"meetingModal-module__additionalFields_content__R1vdK","_additionalFields_content_title":"meetingModal-module__additionalFields_content_title__J167q","_additionalFields_section":"meetingModal-module__additionalFields_section__42MNW","_additionalFields_fields":"meetingModal-module__additionalFields_fields__2GUo3","_input_field":"meetingModal-module__input_field__UHdFn","_timezone_selector":"meetingModal-module__timezone_selector__KxRhD","_meetingType":"meetingModal-module__meetingType__PgDsC","_footer_buttons_right":"meetingModal-module__footer_buttons_right__-UU8x","_main_info_title":"meetingModal-module__main_info_title__BpKXa","discovery_tooltip":"meetingModal-module_discovery_tooltip__4355h","searchLeads":"meetingModal-module_searchLeads__g8sQT","inviteesNotSynced":"meetingModal-module_inviteesNotSynced__ynrrG","titleForm":"meetingModal-module_titleForm__HW-dF","inviteesList":"meetingModal-module_inviteesList__NJQNm","_internal_note":"meetingModal-module__internal_note__zbB7a"};
...
function _toConsumableArray$5(arr) { return _arrayWithoutHoles$5(arr) || _iterableToArray$5(arr) || _unsupportedIterableToArray$e(arr) || _nonIterableSpread$5(); }
...
function _arrayWithoutHoles$5(arr) { if (Array.isArray(arr)) return _arrayLikeToArray$e(arr); }
...
var styles$9 = {"_calendars_container":"calendarsSelector-module__calendars_container__hg0li","_select_disabled":"calendarsSelector-module__select_disabled__FBmCR","_calendars_list":"calendarsSelector-module__calendars_list__GeCPU","_help_container":"calendarsSelector-module__help_container__yByxP","_help_text":"calendarsSelector-module__help_text__z6tfu","_accounts_selector":"calendarsSelector-module__accounts_selector__c7Rea","_select_anchor":"calendarsSelector-module__select_anchor__vhrf2","_icon_container":"calendarsSelector-module__icon_container__uh-FH","_select_text":"calendarsSelector-module__select_text__dwtbM","_email_selector":"calendarsSelector-module__email_selector__Exi3S"};
styleInject(css_248z$9);

function _toConsumableArray$4(arr) { return _arrayWithoutHoles$4(arr) || _iterableToArray$4(arr) || _unsupportedIterableToArray$d(arr) || _nonIterableSpread$4(); }
...
function _arrayWithoutHoles$4(arr) { if (Array.isArray(arr)) return _arrayLikeToArray$d(arr); }
...
var styles$8 = {"_button":"brandedButtons-module__button__PrDge","_icon":"brandedButtons-module__icon__0O2CB","_text":"brandedButtons-module__text__94zcr","_google__button":"brandedButtons-module__google__button__GEzTS brandedButtons-module__button__PrDge","_ms__button":"brandedButtons-module__ms__button__ij275 brandedButtons-module__button__PrDge"};
...
var styles$7 = {"calendar_not_connected":"calendarNotConnected-module_calendar_not_connected__jBJao","calendar_buttons":"calendarNotConnected-module_calendar_buttons__-cbpO","link":"calendarNotConnected-module_link__Yt2p4","day_calendar_not_connected_container":"calendarNotConnected-module_day_calendar_not_connected_container__UFfQN","day_calendar_not_connected":"calendarNotConnected-module_day_calendar_not_connected__6JUW1","_background_image":"calendarNotConnected-module__background_image__Hm-km","day_calendar_buttons":"calendarNotConnected-module_day_calendar_buttons__hDu5Q","day_calendar_not_connected_overlay":"calendarNotConnected-module_day_calendar_not_connected_overlay__Bn14L"};
...
var styles$6 = {"calendar":"calendar-module_calendar__VAah-","calendar_container":"calendar-module_calendar_container__NpIsR","calendar_timestrings_container":"calendar-module_calendar_timestrings_container__6r6HF","calendar_timestring_container":"calendar-module_calendar_timestring_container__k7l8p","calendar_timestring":"calendar-module_calendar_timestring__OBeoj","calendar_timestrings":"calendar-module_calendar_timestrings__AAyB-","calendar_column_headers":"calendar-module_calendar_column_headers__C0NkK","calendar_column_header":"calendar-module_calendar_column_header__QJzIt","calendar_column_header_name":"calendar-module_calendar_column_header_name__VEtYB","calendar_column_header_name_today":"calendar-module_calendar_column_header_name_today__-AOOS","calendar_column_header_date":"calendar-module_calendar_column_header_date__BXHzt","calendar_column_header_date_today":"calendar-module_calendar_column_header_date_today__cQ8gQ","calendar_grid_container":"calendar-module_calendar_grid_container__M73bO","calendar_grid":"calendar-module_calendar_grid__Jd67r","calendar_grid_tiles":"calendar-module_calendar_grid_tiles__8oV7U","calendar_grid_tile":"calendar-module_calendar_grid_tile__8RGwP","calendar_grid_marker_start":"calendar-module_calendar_grid_marker_start__Nlec3","calendar_grid_marker_end":"calendar-module_calendar_grid_marker_end__IdZ6j","calendar_gridcell_container":"calendar-module_calendar_gridcell_container__p9Vr5","calendar_gridcell":"calendar-module_calendar_gridcell__o-KUp","calendar_gridcell_weekend":"calendar-module_calendar_gridcell_weekend__cYfGw","calendar_cell":"calendar-module_calendar_cell__HJM4n","calendar_cell_small":"calendar-module_calendar_cell_small__Dgttn","calendar_cell_placeholder":"calendar-module_calendar_cell_placeholder__Ba8G7","calendar_cell_45":"calendar-module_calendar_cell_45__mHO8w","calendar_now_marker":"calendar-module_calendar_now_marker__ipjto","calendar_cell_extended":"calendar-module_calendar_cell_extended__4ddnf","calendar_cell_title":"calendar-module_calendar_cell_title__ft-iB","calendar_cell_desc":"calendar-module_calendar_cell_desc__C8OTB","calendar_cell_time":"calendar-module_calendar_cell_time__dBufn","event_details_container":"calendar-module_event_details_container__lcC24","event_details_header":"calendar-module_event_details_header__cEAg-","event_details_body":"calendar-module_event_details_body__R3FP8","event_details_datetime":"calendar-module_event_details_datetime__RrDT0","event_details_title":"calendar-module_event_details_title__37tzp","event_details_title_name":"calendar-module_event_details_title_name__3RB7X","event_details_icon":"calendar-module_event_details_icon__RLgv0","event_details_title_text":"calendar-module_event_details_title_text__p0ylw","attendees_details":"calendar-module_attendees_details__JSKl9","attendees_title":"calendar-module_attendees_title__adWLc","attendees_list_container":"calendar-module_attendees_list_container__iV47-","attendee_container":"calendar-module_attendee_container__CJCh8","_invitee_card":"calendar-module__invitee_card__tV-p0","_invitee_info":"calendar-module__invitee_info__VaUPW"};
...
var CalendarEvent = /*#__PURE__*/React.memo(function (_ref2) {
...
function CalendarColumn(_ref3) {
  ...
  return /*#__PURE__*/jsxs("div", {
    ...
    }), (eventPlaceholder === null || eventPlaceholder === void 0 ? void 0 : eventPlaceholder.day) === day && mode === 'week' &&
    /*#__PURE__*/
    // @ts-ignore
    jsx(CalendarEvent, {
...
function _toConsumableArray$2(arr) { return _arrayWithoutHoles$2(arr) || _iterableToArray$2(arr) || _unsupportedIterableToArray$8(arr) || _nonIterableSpread$2(); }
function _nonIterableSpread$2() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray$8(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray$8(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray$8(o, minLen); }
function _iterableToArray$2(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function _arrayWithoutHoles$2(arr) { if (Array.isArray(arr)) return _arrayLikeToArray$8(arr); }
...
var styles$5 = {"_conferencing_container":"conferencingForm-module__conferencing_container__C7ujt","_conferencing_container_marked":"conferencingForm-module__conferencing_container_marked__Sh5NE","_google_meet_icon":"conferencingForm-module__google_meet_icon__4Lu3-","_title":"conferencingForm-module__title__RJ0IK"};
...
var styles$4 = {"_reminder_container":"reminderForm-module__reminder_container__k6pdz","_title":"reminderForm-module__title__X5Wy2","_reminder_form_container":"reminderForm-module__reminder_form_container__CzO-N"};
...
function _toConsumableArray$1(arr) { return _arrayWithoutHoles$1(arr) || _iterableToArray$1(arr) || _unsupportedIterableToArray$6(arr) || _nonIterableSpread$1(); }
function _nonIterableSpread$1() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArray$1(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function _arrayWithoutHoles$1(arr) { if (Array.isArray(arr)) return _arrayLikeToArray$6(arr); }
...
var styles$3 = {"_notes__box":"notesForm-module__notes__box__VTobN","_notes__container":"notesForm-module__notes__container__cqHS8","_notes_content":"notesForm-module__notes_content__OT4fN"};
...
var styles$2 = {"noContacts":"noContacts-module_noContacts__ajK0T"};
...
var styles$1 = {"_item_wrapper":"searchLeadsGuests-module__item_wrapper__WTmw-","_lead_icon":"searchLeadsGuests-module__lead_icon__LyUBO","_lead__info":"searchLeadsGuests-module__lead__info__RqlHf","_lead__company":"searchLeadsGuests-module__lead__company__X-9Yg","_company__icon":"searchLeadsGuests-module__company__icon__jeZgJ","noResults":"searchLeadsGuests-module_noResults__2NeMA","invite_title":"searchLeadsGuests-module_invite_title__ctn16","item":"searchLeadsGuests-module_item__Yt7M1","invite_other":"searchLeadsGuests-module_invite_other__El7eW","chipGroupDiv":"searchLeadsGuests-module_chipGroupDiv__oAsuv","chipSelected":"searchLeadsGuests-module_chipSelected__mTyGo","inputContainer":"searchLeadsGuests-module_inputContainer__H3ou8","dropdown":"searchLeadsGuests-module_dropdown__gv6ms","popup":"searchLeadsGuests-module_popup__oUU4C","spinnerContainer":"searchLeadsGuests-module_spinnerContainer__HWabn"};
...
var styles = {"_container":"dayCalendar-module__container__uCSeO","_filters_wrapper":"dayCalendar-module__filters_wrapper__MNNNf","_calendar_wrapper":"dayCalendar-module__calendar_wrapper__INpN1","_main_filters_container":"dayCalendar-module__main_filters_container__7XNTu","_left_main_filters":"dayCalendar-module__left_main_filters__0nuHh","_day_button":"dayCalendar-module__day_button__B-LSX","_today_button":"dayCalendar-module__today_button__LtWtb","_date_button":"dayCalendar-module__date_button__8SziT","_event_type":"dayCalendar-module__event_type__KxUyw","_secondary_filters_container":"dayCalendar-module__secondary_filters_container__GrVk6","_secondary_filters_right":"dayCalendar-module__secondary_filters_right__KIaYx","_calendar_select":"dayCalendar-module__calendar_select__z7RMy","_selector_anchor":"dayCalendar-module__selector_anchor__E93Z3","_tip_button":"dayCalendar-module__tip_button__3081E"};
