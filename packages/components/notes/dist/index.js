...
import { useToasts, Icon, Text, Spinner, IconButton, Button } from '@bloobirds-it/flamingo-ui';
import { BobjectTypes, COMPANY_FIELDS_LOGIC_ROLE, LEAD_FIELDS_LOGIC_ROLE, OPPORTUNITY_FIELDS_LOGIC_ROLE, BOBJECT_TYPES, ACTIVITY_TYPES_VALUES_LOGIC_ROLE, ACTIVITY_FIELDS_LOGIC_ROLE, ACTIVITY_MAIN_NOTE_VALUES_LOGIC_ROLE } from '@bloobirds-it/types';
import { getTextFromLogicRole, isHtml, createParagraph, api, getFieldByLogicRole } from '@bloobirds-it/utils';
import { useForm, useController } from 'react-hook-form';
import { BobjectSelector } from '@bloobirds-it/bobjects';
import { CopilotSummary } from '@bloobirds-it/copilot';
import { useDebouncedCallback, useCopilotEnabled } from '@bloobirds-it/hooks';
...
import { removeNodes, insertNodes } from '@udecode/plate';
...
var styles$1 = {"container":"noteForm-module_container__IRQ4W","detail_content_container":"noteForm-module_detail_content_container__A1ZA5","body_wrapper":"noteForm-module_body_wrapper__NOq0U","bottom_bar":"noteForm-module_bottom_bar__5tJ0y","bottom_bar_alternative":"noteForm-module_bottom_bar_alternative__Z-RjP","text":"noteForm-module_text__2gJRV","record_related":"noteForm-module_record_related__petZE","editor":"noteForm-module_editor__AyVW1","divider":"noteForm-module_divider__rbNXe","bobject_selector":"noteForm-module_bobject_selector__JW7yV","toolbar":"noteForm-module_toolbar__okaYD","title_container":"noteForm-module_title_container__ZzDnu","title":"noteForm-module_title__ARC2p","mainNote":"noteForm-module_mainNote__SCdi3","noteIcon":"noteForm-module_noteIcon__jLWox","fullHeight":"noteForm-module_fullHeight__6gRqb","isSavingContainer":"noteForm-module_isSavingContainer__UZkM3"};
...
var styles = {"loading":"note-module_loading__g78-2"};
