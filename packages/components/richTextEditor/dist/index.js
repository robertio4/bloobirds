import React, { useMemo, useCallback, useEffect, useState, useRef, Fragment as Fragment$1, memo } from 'react';
import { useActiveUserId, useMeetingLinks, useBaseEmailVariableValue, useLocalStorage, useSignatures, useBaseEmailVariables, useUserSearch } from '@bloobirds-it/hooks';
...
import { getPluginOptions, getAboveNode, removeNodes, insertNodes, getPluginType as getPluginType$1, isDefined, setNodes, findNode as findNode$1, getEditorString, isExpanded, getNodeProps, getNodeLeaf, focusEditor as focusEditor$1, useEditorRef as useEditorRef$1, useHotkeys, usePlateSelectors, getStartPoint, getEndPoint, someNode, useComposedRef, createComponentAs as createComponentAs$1, createElementAs as createElementAs$1, findNodePath, select, getPointAfter, getInjectedPlugins, pipeInsertDataQuery, Box, usePlateEditorRef as usePlateEditorRef$1, createPluginFactory as createPluginFactory$1, onKeyDownToggleElement } from '@udecode/plate-core';
import { useFloatingLinkSelectors as useFloatingLinkSelectors$1, LinkIcon, ShortTextIcon, LaunchIcon, LinkOffIcon } from '@udecode/plate-link';
import { FloatingInputWrapper, FloatingIconWrapper, FloatingVerticalDivider } from '@udecode/plate-ui-toolbar';
import { addProtocolToURL, addHttpsIfNeeded, toTitleCase, api, baseUrls, removeScrollOfBox, recoverScrollOfBox } from '@bloobirds-it/utils';
import { getRangeBoundingClientRect, getDefaultBoundingClientRect } from '@udecode/plate-floating';
import { useFocused, useSelected, useReadOnly } from 'slate-react';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import spacetime from 'spacetime';
import { Media, Image } from '@udecode/plate-media';
import classNames from 'clsx';
import { useTranslation } from 'react-i18next';
import ReactShadowRoot from 'react-shadow-root';
import { useForm, useController } from 'react-hook-form';
import { Tooltip, ToolbarButton, Icon, Toolbar, ToolbarSection, useToasts, IconButton, useVisible, ToolbarMenu, Section, Item, Dropdown, Text, Input, RadioGroup, Radio, Select, Button as Button$1 } from '@bloobirds-it/flamingo-ui';
...
var OpenLinkButton = createComponentAs(function (props) {
...
var UnlinkButton = createComponentAs(function (props) {
...
function _objectSpread$q(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$q(Object(source), !0).forEach(function (key) { _defineProperty$s(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$q(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
function _objectSpread$p(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$p(Object(source), !0).forEach(function (key) { _defineProperty$r(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$p(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
function _objectSpread$o(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$o(Object(source), !0).forEach(function (key) { _defineProperty$q(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$o(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
var FloatingLinkEditRoot = createComponentAs$1(function (props) {
...
var FloatingLinkInsertRoot = createComponentAs$1(function (props) {
...
var styles$a = {"container":"PlateFloatingLink-module_container__puXtn","line":"PlateFloatingLink-module_line__Kpn7h","floatingButtonCss":"PlateFloatingLink-module_floatingButtonCss__mza38","floatingInputCss":"PlateFloatingLink-module_floatingInputCss__OKkF2","plateButtonCss":"PlateFloatingLink-module_plateButtonCss__NZHiz","floatingRootCss":"PlateFloatingLink-module_floatingRootCss__ZvmHh","floatingRowCss":"PlateFloatingLink-module_floatingRowCss__e1mwP"};
...
function _objectSpread$n(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$n(Object(source), !0).forEach(function (key) { _defineProperty$p(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$n(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
function _objectSpread$m(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$m(Object(source), !0).forEach(function (key) { _defineProperty$o(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$m(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
function _objectSpread$l(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$l(Object(source), !0).forEach(function (key) { _defineProperty$n(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$l(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
...
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$7(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e2) { throw _e2; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e3) { didErr = true; err = _e3; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
...
var styles$9 = {"h1":"element-module_h1__3ObGL","h2":"element-module_h2__oEro8","ul":"element-module_ul__dUYlC","ol":"element-module_ol__NrlPG","p":"element-module_p__snPMa","svgs":"element-module_svgs__BOiCQ"};
...
var styles$8 = {"container":"imageLink-module_container__6Ai1C","image":"imageLink-module_image__YkWwM","focused":"imageLink-module_focused__LS7Rm","root":"imageLink-module_root__E8wR6","figure":"imageLink-module_figure__ddW90","handleRight":"imageLink-module_handleRight__j3UZP","handleLeft":"imageLink-module_handleLeft__pUKJm"};
...
var styles$7 = {"container":"meetingLink-module_container__F1Noa","focused":"meetingLink-module_focused__z6mBQ"};
...
var styles$6 = {"container":"rawHTMLBlock-module_container__GlDen","focused":"rawHTMLBlock-module_focused__l7Ri4"};
...
var styles$5 = {"toggle":"replyHistory-module_toggle__-W2Fl","history":"replyHistory-module_history__pUOp8"};
...
var styles$4 = {"container":"slotsBlock-module_container__xP-6V","focused":"slotsBlock-module_focused__hmYz0"};
...
var styles$3 = {"container":"templateVariable-module_container__tLPbo","focused":"templateVariable-module_focused__UiEZw","missingContainer":"templateVariable-module_missingContainer__YgFoZ","missingFocused":"templateVariable-module_missingFocused__9CNAD"};
...
var styles$2 = {"colorButton":"ColorPicker-module_colorButton__iykbC","colorButtonBright":"ColorPicker-module_colorButtonBright__ygbUV","colorInputContainer":"ColorPicker-module_colorInputContainer__T7E3F","colorInputInput":"ColorPicker-module_colorInputInput__QIhOm","colorPicker":"ColorPicker-module_colorPicker__svNEA","divider":"ColorPicker-module_divider__ql4gH","clearButton":"ColorPicker-module_clearButton__sg-iv","colors":"ColorPicker-module_colors__nNhaj","customColors":"ColorPicker-module_customColors__KEaMY"};
...
var styles$1 = {"label":"editorToolbar-module_label__O-xD2","input":"editorToolbar-module_input__3rsAn","variableList":"editorToolbar-module_variableList__Veozi","floatingTemplateVariable":"editorToolbar-module_floatingTemplateVariable__yMi39","meetingLinksDropdownWrapper":"editorToolbar-module_meetingLinksDropdownWrapper__B1lZc","templateMeetingLinksDropdownWrapper":"editorToolbar-module_templateMeetingLinksDropdownWrapper__M8Fvt","templateMeetingLinkCallout":"editorToolbar-module_templateMeetingLinkCallout__KYS7k","meetingLinksHeader":"editorToolbar-module_meetingLinksHeader__B9OTV","meetingLinksTextDisplayInput":"editorToolbar-module_meetingLinksTextDisplayInput__pZhXE","radioGroup":"editorToolbar-module_radioGroup__q98mq","dropdownSelects":"editorToolbar-module_dropdownSelects__eZ5PX","addButton":"editorToolbar-module_addButton__T-sCA","templateVariable":"editorToolbar-module_templateVariable__mwldh","toolbar":"editorToolbar-module_toolbar__-f8sS","timeSlotsButton":"editorToolbar-module_timeSlotsButton__KJCUI","sizeDropdown":"editorToolbar-module_sizeDropdown__I-AG-","sizeItem":"editorToolbar-module_sizeItem__MlEXE","sizeContainer":"editorToolbar-module_sizeContainer__qBD8r","colorContainer":"editorToolbar-module_colorContainer__m-D9W","itemSignature":"editorToolbar-module_itemSignature__f11bQ","separator":"editorToolbar-module_separator__-5Rjg"};
...
var styles = {"plate_container":"richTextEditor-module_plate_container__c59X1","plate_container_sfc":"richTextEditor-module_plate_container_sfc__YvZH2"};
...
var PlateWrapper = /*#__PURE__*/memo(function (_ref2) {
  var id = _ref2.id,
